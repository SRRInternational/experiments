...
!(function () {
  ...
  const Nr = (e, t, n, o) =>
    ...
    Fs = (e = {}) => {
      ...
      const s = {},
        ...
        d = ((e) => {
          ...
          return (
            "html5-strict" !== e &&
              (q(Es("acronym applet basefont big font strike tt"), (e) => {
                a(e, "", n);
              }),
    ...
    Vs = (e) => {
      const t = js.exec(e);
      if (null !== t) return I.some($s(t[1], t[2], t[3], "1"));
      const n = Hs.exec(e);
            ...
            for (
              ...
              if (t && d) {
                ...
                "font-weight" === t && "700" === d
                  ...
                  "rgb" ==
                    ((E = d),
                    js.test(E) ? "rgb" : Hs.test(E) ? "rgba" : "other") &&
                    Vs(d).each((e) => {
    ...
    Gs = (e, t) => {
      const n = null != t ? t : {};
      for (const t in e) ke(Ys, t) || (n[t] = e[t]);
      return (
    ...
    ma = (e, t = {}) => {
      ...
      const a = rs.forElement(Cn(e), {
        ...
        F = (e, t) =>
          B(e, (e) => {
            ...
            return (
              t &&
                q(In(n), (e) => {
                  Yt(e) && 0 === e.dom.length ? xo(e) : ho(n, e);
                }),
              xo(n),
              n.dom
            );
        ...
        Y = {
          ...
          events: c,
          isBlock: (e) =>
            m(e) ? ke(u, e) : er(e) && (ke(u, e.nodeName) || Zr(l, e)),
          root: null,
          ...
          setStyle: (e, n, o) => {
            B(e, (e) => {
              const r = Cn(e);
              ua(r, n, o), t.update_styles && ca(d, r);
            });
          },
          getStyle: S,
          setStyles: (e, n) => {
          ...
          const o = t.keep_values,
            ...
            s = {
              style: {
                set: (t, n) => {
                  const r = Cn(t);
                  o && ia(r, sa, n), rn(r, "style"), m(n) && co(r, e.parse(n));
                },
                get: (t) => {
                  const n = Cn(t),
  ...
  (ma.DOM = ma(document)), (ma.nodeIndex = da);
  const fa = ma.DOM;
  class ga {
    constructor(e = {}) {
      (this.states = {}),
    ...
    ya = () => {
      const e = [],
        ...
        a = (e, n) => {
          ...
          !o ||
            (n && -1 === ("," + (n || "") + ",").indexOf("," + o + ",")) ||
            ga.ScriptLoader.add(t[e] + "/langs/" + o + ".js");
        },
        i = (e, t = "added") =>
  ...
  const Da = (e) => {
    ...
    qi = (e) => (e ? e.createRange() : ma.DOM.createRng()),
    Wi = (e) => m(e) && /[\r\n\t ]/.test(e),
  ...
  const im = (e) => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
    ...
    _m = (e, t) =>
      !!e.getTextBlockElements()[t.nodeName.toLowerCase()] || Zr(e, t),
    ...
    Om = (e, t) => {
      if (y(e)) return null;
      {
        let n = String(e);
        return (
          ("color" !== t && "backgroundColor" !== t) || (n = Ws(n)),
    ...
    df = (e) => {
      ...
      ((e, t) => {
        const n = xa(),
          ...
          r = (e) => {
            var t, n;
            e.attr(ka(), null), e.attr(xa(), null), e.attr(_a(), null);
  ...
  const uf = (e, t, n) =>
    ...
    kf = (e, t) => {
      ...
      const E = (e) => C(e) && (hr(e) || n.is(e, "figure.image")),
  ...
  const ng = (e) => "textarea" === $t(e),
    ...
    ag = (e, t, n, o) => {
      ...
      const a = ((e, t) => {
        ...
        return ho(n.element, o), og(o, () => xo(o));
  ...
  const wp = ["font", "text-decoration", "text-emphasis"],
    ...
    Nh = /[\u0591-\u07FF\uFB1D-\uFDFF\uFE70-\uFEFC]/,
    Rh = (e, t) => xn(Cn(t), bd(e)) && !Zr(e.schema, t) && e.dom.isEditable(t),
    Ah = (e) => {
      var t;
      return (
        "rtl" === ma.DOM.getStyle(e, "direction", !0) ||
        ((e) => Nh.test(e))(
    ...
    Th = (e, t, n) => {
      const o = ((e, t, n) => Y(ma.DOM.getParents(n.container(), "*", t), e))(
        e,
        t,
        n
      );
      ...
      if (
        ...
        const t = Lt(Tn(a), n)
          ...
          : Tn((i = a))
              ...
              .getOr([]);
        q(t.concat(In(n)), (t) => {
          _n(t, a) || Sn(t, a) || !Tr(e.schema, t) || xo(t);
        });
      }
      var i;
    },
          ...
          I.from(e.getParent(t, "td,th"))
            ...
            .each((e) =>
              ((e, t) => {
                zn(e).each((n) => {
                  Pn(n).each((o) => {
                    t.isBlock($t(e)) && $a(n) && t.isBlock($t(o)) && xo(n);
                  });
                });
              })(e, n)
            );
    ...
    sv = (e, t) => {
      const { caretContainer: n, caretPosition: o } = rv(t);
      return ho(Cn(e), n), xo(Cn(e)), o;
    },
    av = (e, t) => {
        ...
        if (!e.selection.getRng().collapsed) {
          ...
          q(n, (e) => {
            ((e, t) => {
              const n = Cn(t),
                o = Rn(n).dom;
              xo(n), wo(Cn(e), [vn("br", o), vn("br", o), ...In(n)]);
            })(e.previousSibling, e);
          });
        }
      });
  })("pre");
  const dv = ["fontWeight", "fontStyle", "color", "fontSize", "fontFamily"],
    cv = (e, t) => {
      const n = e.get(t);
      return p(n)
        ? Q(
            ...
            (e) =>
              Fm(e) &&
              "span" === e.inline &&
              ((e) => f(e.styles) && $(fe(e.styles), (e) => H(dv, e)))(e)
          )
        : I.none();
    },
    uv = (e, t) => ju(t, Qi.fromRangeStart(e)).isNone(),
    mv = (e, t) =>
      !1 ===
      zu(t, Qi.fromRangeEnd(e)).exists(
        (e) => !pr(e.getNode()) || zu(t, e).isSome()
      ),
    fv = (e) => (t) => Er(t) && e.isEditable(t),
    gv = (e) => Y(e.getSelectedBlocks(), fv(e.dom)),
    pv = Dt.each,
    hv = (e) => er(e) && !rm(e) && !qu(e) && !sr(e),
    bv = (e, t) => {
      for (let n = e; n; n = n[t]) {
    ...
    yv = (e, t, n, o) => {
      ...
      if (o && !1 !== t.merge_siblings) {
        const t = null !== (r = vv(e, km(o), o)) && void 0 !== r ? r : o;
        vv(e, t, km(t, !0));
      }
    },
    Cv = (e, t, n) => {
      pv(e.childNodes, (e) => {
        hv(e) && (t(e) && n(e), e.hasChildNodes() && Cv(e, t, n));
      });
    },
    wv = (e, t) => (n) => !(!n || !Bm(e, n, t)),
    Ev = (e, t, n) => (o) => {
    ...
    xv = xl([{ keep: [] }, { rename: ["name"] }, { removed: [] }]),
    kv = /^(src|href|style)$/,
    _v = Dt.each,
    Sv = Tm,
    Nv = (e, t, n) => e.isChildOf(t, n) && t !== n && !e.isBlock(n),
    Rv = (e, t, n) => {
    ...
    Bv = (e, t, n) => {
      ...
      Mm(n) &&
        o === s.getRoot() &&
        ((n.list_block && Sv(t, n.list_block)) ||
          q(ce(t.childNodes), (t) => {
            Sm(e, a, t.nodeName.toLowerCase())
              ? r
                ? r.appendChild(t)
                : ((r = Tv(s, t, a)), s.setAttribs(r, Wl(e)))
              : (r = null);
          })),
    ...
    Lv = (e, t, n, o, r) => {
      let s = !1;
      _v(n.styles, (a, i) => {
        const { name: l, value: d } = Pv(i, a, o),
          c = Om(d, l);
        (n.remove_similar || h(d) || !er(r) || Sv(Bm(e, r, l), c)) &&
          e.setStyle(t, l, ""),
          (s = !0);
      }),
        s && Dv(e, t);
    ...
    Mv = (e, t, n, o, r) => {
      ...
      if ("all" !== t.remove) {
        Lv(s, l, t, n, r),
          _v(t.attributes, (e, o) => {
            const { name: a, value: i } = Pv(o, e, n);
            if (
              t.remove_similar ||
              h(i) ||
              !er(r) ||
              Sv(s.getAttrib(r, a), i)
            ) {
              if ("class" === a) {
              ...
              if (
                (kv.test(a) && l.removeAttribute("data-mce-" + a),
                "style" === a &&
                  or(["li"])(l) &&
      ...
      return "none" !== t.remove ? (Bv(e, l, t), xv.removed()) : xv.keep();
    },
    Iv = (e, t, n, o) =>
      Mv(e, t, n, o, o).fold(
        N(o),
        ...
        ((e, t, n, o, r) => {
          const s = e.formatter.get(t),
              ...
              return ((e, t, n, o, r, s, a, i) => {
                ...
                if (n) {
                  ...
                  for (let n = o.parentNode; n && n !== s; n = n.parentNode) {
                    ...
                    for (
                      let n = 0;
                      n < t.length && ((o = Iv(e, t[n], i, o)), null !== o);
                      n++
                    );
            ...
            f = (t) => {
              ...
              if (a.split) {
                if (
                  ((r = Xf(r)), (n = Rv(e, r, !0)), (o = Rv(e, r)), n !== o)
                ) {
                  if (((n = Av(n, !0)), (o = Av(o, !1)), Nv(i, n, o))) {
          ...
          if (o) {
            ...
            l.isCollapsed() && Fm(a) && !um(e).length
              ...
              ((e, t, n) => {
                "removeformat" === t
                  ? q(gv(e.selection), (t) => {
                      q(dv, (n) => e.dom.setStyle(t, n, "")), Dv(e.dom, t);
                    })
                  : cv(e.formatter, t).each((t) => {
                      q(gv(e.selection), (o) => Lv(e.dom, o, t, n, null));
                    });
              })(e, t, n),
              gf(e, t, o, n);
        })(e, t, n, o, r);
              ...
              (!(l.length > 1) && o.isBlock(a)) || 0 !== i
                ? (Fm(s) || (Mm(s) && s.wrapper)) &&
                  ...
                  ((e, t, n, o) => {
                    zv(t, (t) => {
                      Fm(t) &&
                        zv(e.dom.select(t.inline, o), (o) => {
                          hv(o) && Uv(e, t, n, o, t.exact ? o : null);
                        }),
                        ((e, t, n) => {
                  ...
                  ((e, t, n, o, r) => {
                    ...
                    (Yb(e, s, n, o) && Uv(e, t, o, r)) ||
                      (t.merge_with_parents &&
                        s &&
                        e.dom.getParent(
                          s,
                          (s) => !!Yb(e, s, n, o) && (Uv(e, t, o, r), !0)
                        ));
                  })(e, s, t, n, a),
                  ((e, t, n, o) => {
                    if (t.styles && t.styles.backgroundColor) {
                      const r = wv(e, "fontSize");
                      Cv(
                        o,
    ...
    Vv = (e, t, n, o) => {
      (o || e.selection.isEditable()) && $v(e, t, n, o);
    },
    qv = (e) => ke(e, "vars"),
    Wv = (e) => e.selection.getStart(),
    Kv = (e, t, n, o, r) =>
      Z(
        t,
        (t) => {
    ...
    Gv = (e, t, n) => {
      ...
      pe(n, (n, r) => {
        const s = (n) => {
          const s = Kv(e, o, r, n.similar, qv(n) ? n.vars : void 0),
            a = s.isSome();
          if (n.state.get() !== a) {
            n.state.set(a);
            const e = s.getOr(t);
  ...
  const oy = (e, t, n) =>
    ...
    ry = (e, t, n) => {
      const o = e.create("blobid" + ny++, t, n);
      return e.add(o), o;
    },
    sy = (e, t, n = !1) =>
      oy(t, n, (t, n) =>
        I.from(e.getByData(t, n)).orThunk(() =>
          ey(n, t).map((n) => ry(e, n, t))
        )
      ),
    ay =
    ...
    dy = (e, t) => $e(e, `${t}/`),
    {
      ...
      isFrozen: my,
      getPrototypeOf: fy,
      getOwnPropertyDescriptor: gy,
    } = Object;
  let { freeze: py, seal: hy, create: by } = Object,
    { apply: vy, construct: yy } = "undefined" != typeof Reflect && Reflect;
  vy ||
    (vy = function (e, t, n) {
      return e.apply(t, n);
    }),
  ...
  const Cy = By(Array.prototype.forEach),
    wy = By(Array.prototype.pop),
    Ey = By(Array.prototype.push),
    xy = By(String.prototype.toLowerCase),
    ky = By(String.prototype.toString),
    _y = By(String.prototype.match),
    Sy = By(String.prototype.replace),
    Ny = By(String.prototype.indexOf),
    Ry = By(String.prototype.trim),
    Ay = By(RegExp.prototype.test),
    Ty =
      ((Oy = TypeError),
      function () {
  ...
  function Py(e, t, n) {
    var o;
    (n = null !== (o = n) && void 0 !== o ? o : xy), uy && uy(e, null);
    let r = t.length;
    for (; r--; ) {
      let o = t[r];
      if ("string" == typeof o) {
  ...
  function Ly(e, t) {
    for (; null !== e; ) {
      const n = gy(e, t);
      if (n) {
        if (n.get) return By(n.get);
        if ("function" == typeof n.value) return By(n.value);
      }
      e = fy(e);
    }
    return function (e) {
  ...
  var nC = Object.freeze({
    ...
    ARIA_ATTR: Zy,
    IS_ALLOWED_URI: Qy,
    IS_SCRIPT_OR_DATA: Jy,
    ATTR_WHITESPACE: eC,
    DOCTYPE_NAME: tC,
  });
  const oC = () => ("undefined" == typeof window ? null : window);
  var rC = (function e() {
    let t =
      arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : oC();
    const n = (t) => e(t);
    if (
      ((n.version = "3.0.5"),
      (n.removed = []),
    ...
    let { IS_ALLOWED_URI: L } = nC,
      M = null;
    const I = Py({}, [...My, ...Iy, ...Fy, ...zy, ...Hy]);
    let F = null;
    const U = Py({}, [...$y, ...Vy, ...qy, ...Wy]);
    let z = Object.seal(
        Object.create(null, {
          tagNameCheck: {
            writable: !0,
    ...
    let ie = null;
    const le = Py({}, ["audio", "video", "img", "source", "image", "track"]);
    let de = null;
    const ce = Py({}, [
        "alt",
        "class",
    ...
    const Ee = s.createElement("form"),
          ...
          if (
            ...
            (ve = ve =
              -1 === ye.indexOf(e.PARSER_MEDIA_TYPE)
                ? "text/html"
                : e.PARSER_MEDIA_TYPE),
            (Ce = "application/xhtml+xml" === ve ? ky : xy),
            (M = "ALLOWED_TAGS" in e ? Py({}, e.ALLOWED_TAGS, Ce) : I),
            (F = "ALLOWED_ATTR" in e ? Py({}, e.ALLOWED_ATTR, Ce) : U),
            (he =
              "ALLOWED_NAMESPACES" in e
                ? Py({}, e.ALLOWED_NAMESPACES, ky)
                : be),
            (de =
              "ADD_URI_SAFE_ATTR" in e
                ? Py(Dy(ce), e.ADD_URI_SAFE_ATTR, Ce)
                : ce),
            (ie =
              "ADD_DATA_URI_TAGS" in e
                ? Py(Dy(le), e.ADD_DATA_URI_TAGS, Ce)
                : le),
            (se = "FORBID_CONTENTS" in e ? Py({}, e.FORBID_CONTENTS, Ce) : ae),
            (j = "FORBID_TAGS" in e ? Py({}, e.FORBID_TAGS, Ce) : {}),
            (H = "FORBID_ATTR" in e ? Py({}, e.FORBID_ATTR, Ce) : {}),
            ...
            re &&
              ((M = Py({}, [...Hy])),
              (F = []),
              !0 === re.html && (Py(M, My), Py(F, $y)),
              !0 === re.svg && (Py(M, Iy), Py(F, Vy), Py(F, Wy)),
              !0 === re.svgFilters && (Py(M, Fy), Py(F, Vy), Py(F, Wy)),
              !0 === re.mathMl && (Py(M, zy), Py(F, qy), Py(F, Wy))),
            e.ADD_TAGS && (M === I && (M = Dy(M)), Py(M, e.ADD_TAGS, Ce)),
            e.ADD_ATTR && (F === U && (F = Dy(F)), Py(F, e.ADD_ATTR, Ce)),
            e.ADD_URI_SAFE_ATTR && Py(de, e.ADD_URI_SAFE_ATTR, Ce),
            e.FORBID_CONTENTS &&
              (se === ae && (se = Dy(se)), Py(se, e.FORBID_CONTENTS, Ce)),
            ne && (M["#text"] = !0),
            Y && Py(M, ["html", "head", "body"]),
            M.table && (Py(M, ["tbody"]), delete j.tbody),
      ...
      _e = Py({}, ["mi", "mo", "mn", "ms", "mtext"]),
      Se = Py({}, ["foreignobject", "desc", "title", "annotation-xml"]),
      Ne = Py({}, ["title", "style", "font", "a", "script"]),
      Re = Py({}, Iy);
    Py(Re, Fy), Py(Re, Uy);
    const Ae = Py({}, zy);
    Py(Ae, jy);
    const Te = function (e) {
        Ey(n.removed, { element: e });
        try {
      ...
      Oe = function (e, t) {
        try {
          Ey(n.removed, { attribute: t.getAttributeNode(e), from: t });
        } catch (e) {
          Ey(n.removed, { attribute: null, from: t });
        }
      ...
      Me = function (e) {
        ...
        if (
          ...
          e.hasChildNodes() &&
            ...
            Ay(/<[/\w]/g, e.innerHTML) &&
            Ay(/<[/\w]/g, e.textContent))
        )
          return Te(e), !0;
        if (!M[r] || j[r]) {
          if (!j[r] && Fe(r)) {
            if (z.tagNameCheck instanceof RegExp && Ay(z.tagNameCheck, r))
              return !1;
        ...
        return e instanceof d &&
          ...
          : ("noscript" !== r && "noembed" !== r && "noframes" !== r) ||
            !Ay(/<\/no(script|embed|frames)/i, e.innerHTML)
          ? (K &&
              3 === e.nodeType &&
              ((t = e.textContent),
              (t = Sy(t, R, " ")),
              ...
              (t = Sy(t, T, " ")),
              e.textContent !== t &&
                (Ey(n.removed, { element: e.cloneNode() }),
                (e.textContent = t))),
    ...
    return (
      (n.sanitize = function (e) {
        ...
        if (
          ...
          if ("function" != typeof e.toString)
            throw Ty("toString is not a function");
          if ("string" != typeof (e = e.toString()))
            throw Ty("dirty is not a string, aborting");
        }
        ...
        return (
          Y &&
            ...
            Ay(tC, t.ownerDocument.doctype.name) &&
            (u = "<!DOCTYPE " + t.ownerDocument.doctype.name + ">\n" + u),
          K && ((u = Sy(u, R, " ")), (u = Sy(u, A, " ")), (u = Sy(u, T, " "))),
      ...
      (n.addHook = function (e, t) {
        "function" == typeof t && ((N[e] = N[e] || []), Ey(N[e], t));
      }),
      (n.removeHook = function (e) {
        if (N[e]) return wy(N[e]);
      }),
  ...
  const sC = Dt.each,
    ...
    lC = { ftp: 21, http: 80, https: 443, mailto: 25 },
    dC = ["img", "video"],
    cC = (e, t, n) => {
      const o = ((e) => {
        try {
  ...
  class uC {
    ...
    constructor(e, t = {}) {
      ...
      if (
        ...
        const t = n ? n.path : new uC(document.location.href).directory;
    ...
    toRelative(e) {
      if ("./" === e) return e;
      const t = new uC(e, { base_uri: this });
      if (
    ...
    toAbsolute(e, t) {
      const n = new uC(e, { base_uri: this });
  ...
  const pC = (e, t, n, o, r) => {
      ...
      if (!g && m(p)) return void ("all" === p ? xo(f) : ko(f));
        ...
        if ((C(r) && (r.allowedTags[u] = !0), d && h && !g)) {
          if (
            (q(
              ...
              (e) => {
                Jt(f, e.name, "{$uid}" === e.value ? "mce_" + gC++ : e.value);
              }
            ),
            q(
    ...
    bC = (e, t) =>
      e.hasAttribute(fC) && ("id" === t || "class" === t || "style" === t),
    vC = (e, t) => e in t.getBoolAttrs(),
    yC = (e, t, n, o) => {
      ...
      for (let s = r.length - 1; s >= 0; s--) {
        const a = r[s],
          i = a.name,
          l = a.value;
        hC(t, n, o, e.tagName.toLowerCase(), i, l) || bC(e, i)
          ? vC(i, n) && e.setAttribute(i, i)
          : e.removeAttribute(i);
      }
    },
    CC = (e, t, n) => {
    ...
    kC = (e, t, n, o) => {
      ...
      for (let t = 0, r = a.length; t < r; t++) {
        ...
        Mr(i.name) || kC(i, r, n, o), e.append(i);
      }
    },
    _C = (e = {}, t = Fs()) => {
      const n = Zv(),
        ...
        a = ((e, t) => {
          ...
          if (e.sanitize) {
            ...
            return { sanitizeHtmlElement: r, sanitizeNamespaceElement: wC };
          }
          return {
        ...
        p = {
          ...
          parse: (e, n = {}) => {
            ...
            Wr(t, c);
            const m = new Jg(d, 11);
            kC(m, c, t.getSpecialElements(), a.sanitizeNamespaceElement),
              (c.innerHTML = "");
            const [f, p] = ((e, t, n, o) => {
                const r = n.validate,
                  s = t.getNonEmptyElements(),
                  ...
                  f = (n) =>
                    n.name in i || Jr(t, n) || (Mr(n.name) && n.parent === e),
                  g = (t, n) => {
      ...
      return (
        ((e, t) => {
          ...
          t.convert_unsafe_embeds &&
            ...
            a && e.addNodeFilter("iframe", (e) => q(e, (e) => ly(e, i)));
        })(p, r),
        ((e, t, n) => {
    ...
    SC = (e, t, n) => {
      ...
      if (Ub(e)) {
        if (r.content !== o) {
          const t = _C({ validate: !1, forced_root_block: !1, ...n }).parse(
            r.content,
            { context: e.name }
          );
          return { ...r, content: t };
    ...
    AC = (e, t, n) => {
      ...
      {
        const o = SC(t, (t) => hf(e, { ...n, content: t }), NC(e));
        return o.content;
      }
    },
    TC = (e, t) => {
    ...
    BC = (e, t, n) => ({ element: e, width: t, rows: n }),
    PC = (e, t) => ({ element: e, cells: t }),
    DC = (e, t) => ({ x: e, y: t }),
    LC = (e, t) => nn(e, t).bind(Ze).getOr(1),
    MC = (e, t, n) => {
      const o = e.rows;
      return !!(o[n] ? o[n].cells : [])[t];
    },
    IC = (e) => X(e, (e, t) => (t.cells.length > e ? t.cells.length : e), 0),
    FC = (e, t) => {
      const n = e.rows;
      for (let e = 0; e < n.length; e++) {
        const o = n[e].cells;
        for (let n = 0; n < o.length; n++)
          if (_n(o[n], t)) return I.some(DC(n, e));
      }
      return I.none();
    },
    UC = (e, t, n, o, r) => {
              ...
              FC(e, n).map((n) =>
                ((e, t, n) => {
                  const o = t.x,
                    ...
                    s = n.x,
                    a = n.y,
                    i = r < a ? UC(e, o, r, s, a) : UC(e, o, a, s, r);
                  return BC(e.element, IC(i), i);
                })(e, t, n)
              )
            ))(r, n, o).map((e) => Ff([zC(e)]));
        })
        ...
        : ((e, t, n) =>
            t.length > 0 && t[0].collapsed
              ...
              : ((e, t, n) =>
                  ...
                  })(Cn(t.cloneContents()), jC(e, t, n)))(e, t[0], n))(e, t, n);
    },
    qC = (e, t) => t >= 0 && t < e.length && im(e.charAt(t)),
    WC = (e) => ei(e.innerText),
    KC = (e) =>
      er(e)
        ? e.outerHTML
    ...
    GC = Le(() => document.implementation.createHTMLDocument("undo")),
    XC = (e) => {
      ...
      return ((e) => null !== e.querySelector("iframe"))(n)
        ? {
            type: "fragmented",
            fragments: Y(V(ce(n.childNodes), _(ei, KC)), (e) => e.length > 0),
            content: "",
            bookmark: null,
            beforeBookmark: null,
          }
    ...
    QC = (e) => ("fragmented" === e.type ? e.fragments.join("") : e.content),
    JC = (e) => {
      const t = vn("body", GC());
      return No(t, QC(e)), q(zo(t, "*[data-mce-bogus]"), ko), So(t);
    },
    ew = (e, t) =>
      !(!e || !t) &&
      (!!((e, t) => QC(e) === QC(t))(e, t) ||
    ...
    rw = (e) => ({
      ...
      undoManager: {
        beforeChange: (t, n) =>
          ((e, t, n) => {
            tw(t) && n.set(yl(e.selection));
          })(e, t, n),
        add: (t, n, o, r, s, a) =>
          ((e, t, n, o, r, s, a) => {
            const i = XC(e),
              l = Dt.extend(s || {}, i);
            if (!tw(o) || e.removed) return null;
        ...
        undo: (t, n, o) =>
          ((e, t, n, o) => {
            let r;
            return (
              t.typing && (t.add(), (t.typing = !1), nw(t, !1, n)),
              o.get() > 0 &&
                (o.set(o.get() - 1),
                (r = t.data[o.get()]),
                ZC(e, r, !0),
        ...
        hasUndo: (t, n) =>
          ((e, t, n) =>
            n.get() > 0 || (t.typing && t.data[0] && !ew(XC(e), t.data[0])))(
            e,
            t,
            n
          ),
        ...
        transact: (e, t, n) =>
          ((e, t, n) => (ow(e, t), e.beforeChange(), e.ignore(n), e.add()))(
            e,
            t,
            n
          ),
      ...
      formatter: {
        ...
        apply: (t, n, o) => Vv(e, t, n, o),
        remove: (t, n, o, r) => Fv(e, t, n, o, r),
        toggle: (t, n, o) =>
          ((e, t, n, o) => {
            const r = e.formatter.get(t);
            r &&
                  ...
                  return ((e) =>
                    I.from(e.selection.getRng())
                      .map((t) => {
                        ...
                        if (
                          (e.dom.remove(i), qC(d, 0) || qC(d, d.length - 1))
                        ) {
                          const e = o.getOr(r),
                            t = WC(e),
                            n = t.indexOf(l);
                      ...
                      .getOr(""))(e);
                {
                  const n = ((e, t) => {
                    const n = e.selection.getRng(),
                      ...
                      s = Yg(e, dm(r)),
                      a = t.contextual
                        ? VC(Cn(e.getBody()), s, e.schema).dom
                        : n.cloneContents();
                    return (
                      a && o.appendChild(a),
    ...
    sw = (e) => ke(e.plugins, "rtc"),
    aw = (e) => (e.rtcInstance ? e.rtcInstance : rw(e)),
    iw = (e) => {
      const t = e.rtcInstance;
      if (t) return t;
      throw new Error("Failed to get RTC instance not yet initialized.");
    },
    lw = (e) => iw(e).init.bindEvents(),
    dw = (e) => (0 === e.dom.length ? (xo(e), I.none()) : I.some(e)),
    cw = (e, t, n, o, r) => {
      e.bind(
        (e) => (
  ...
  const mw = (e) => !(!e || !e.ownerDocument) && Sn(Cn(e.ownerDocument), Cn(e)),
    fw = (e, t, n, o) => {
      let r, s;
      const { selectorChangedWithUnbind: a } = ((e, t) => {
          ...
          ((e, t, n = {}) => {
            ...
            TC(e, o).each((t) => {
              ...
              ((e, t, n) => {
                ...
                const s = o.bind(Pn).filter(Yt).bind(dw),
                  a = r.bind(Dn).filter(Yt).bind(dw);
                cw(s, o, e, !0, n), cw(a, r, e, !1, n), e.collapse(!1);
        ...
        u = (e, t) => {
          if (!((e) => !!e && mw(e.startContainer) && mw(e.endContainer))(e))
            return;
          const n = d();
          if (
        ...
        f = {
          ...
          getContent: (e) =>
            ((e, t = {}) =>
              ((e, t, n) => iw(e).selection.getContent(t, n))(
                e,
    ...
    bw = (e, t, n = {}) => {
      ...
      return TC(e, o)
        .map((t) => {
          const n = ((e, t, n) => aw(e).editor.setContent(t, n))(
            e,
            t.content,
            t
          );
          return OC(e, n.html, t), n.content;
        })
        .getOr(t);
    },
    vw =
    ...
    Rw = (e) =>
      Q(ww, (t) => t.name === e).fold(
        () => e,
        (t) => (t.replacedWith ? `${e}, replaced by ${t.replacedWith}` : e)
      ),
    Aw = ma.DOM,
    Tw = (e) => I.from(e).each((e) => e.destroy()),
    Ow = (() => {
      const e = {};
      return {
        add: (t, n) => {
    ...
    Bw = ya.ModelManager,
    Pw = (e, t) => t.dom[e],
    Dw = (e, t) => parseInt(uo(t, e), 10),
    Lw = T(Pw, "clientWidth"),
    Mw = T(Pw, "clientHeight"),
    Iw = T(Dw, "margin-top"),
    Fw = T(Dw, "margin-left"),
    Uw = (e) => {
      const t = [],
                    ...
                    return C(s)
                      ...
                      : ((o = t),
                        $e(o, "blob:")
                          ...
                          ty(t).then((o) =>
                            oy(o, !1, (n) => I.some(ry(e, t, n))).getOrThunk(n)
                          )
                        );
                  }
                  var o, r;
                  return $e(t, "data:")
                    ? sy(e, t).fold(n, (e) => Promise.resolve(e))
  ...
  const Jw = (e, t) => {
                      ...
                      n.status && ed(e)
                        ...
                        : n.error &&
                          ...
                          ((e, t) => {
                            Vw(
                              e,
                              va.translate(["Failed to upload image: {0}", t])
                            );
                          })(e, n.error.message)),
                      {
                        element: l,
    ...
    oE = { remove_similar: !0, inherit: !1 },
    rE = { selector: "td,th", ...oE },
    sE = {
      tablecellbackgroundcolor: {
        styles: { backgroundColor: "%value" },
        ...rE,
      },
      tablecellverticalalign: { styles: { "vertical-align": "%value" }, ...rE },
      tablecellbordercolor: { styles: { borderColor: "%value" }, ...rE },
      tablecellclass: { classes: ["%value"], ...rE },
      tableclass: { selector: "table", classes: ["%value"], ...oE },
      tablecellborderstyle: { styles: { borderStyle: "%value" }, ...rE },
      tablecellborderwidth: { styles: { borderWidth: "%value" }, ...rE },
    },
    aE = N(sE),
    iE = Dt.each,
    lE = ma.DOM,
    ...
    cE = (e, t) => {
      const n = (t && t.schema) || Fs({}),
        o = (e) => {
          ...
          return (
            ((e, t) => {
              t.classes.length > 0 && lE.addClass(e, t.classes.join(" ")),
                lE.setAttribs(e, t.attrs);
            })(n, t),
            n
          );
        },
        r = (e, t, s) => {
          ...
          const u = dE(a) ? a.siblings : void 0;
          return r(c, t, u);
        },
        s = lE.create("div");
      if (e.length > 0) {
    ...
    mE = (e, t) => {
      ...
      const r = (e) => (m(e) ? e.replace(/%(\w+)/g, "") : ""),
        s = (t, n) => lE.getStyle(null != n ? n : e.getBody(), t, !0);
      if (m(t)) {
        const n = e.formatter.get(t);
        if (!n) return "";
        t = n[0];
      ...
      var d;
      l.length > 0
        ? (l[0].name || (l[0].name = i), (i = t.selector), (a = cE(l, e)))
        : (a = cE([i], e));
      const c = lE.select(i, a)[0] || a.firstChild;
      iE(t.styles, (e, t) => {
        const n = r(e);
        n && lE.setStyle(c, t, n);
      }),
        iE(t.attributes, (e, t) => {
          const n = r(e);
          n && lE.setAttrib(c, t, n);
        }),
        iE(t.classes, (e) => {
          const t = r(e);
          lE.hasClass(c, t) || lE.addClass(c, t);
        }),
        e.dispatch("PreviewFormats"),
        lE.setStyles(a, { position: "absolute", left: -65535 }),
          ...
          if (
            !(
              ("background-color" === e &&
                ...
                ((t = s(e)), "#ffffff" === Ws(t).toLowerCase())) ||
              ("color" === e && "#000000" === Ws(t).toLowerCase())
            )
          ) {
    ...
    fE = (e) => {
      ...
      return (
          ...
          })(n, e),
        {
          ...
          apply: (t, n, o) => {
            ((e, t, n, o) => {
              iw(e).formatter.apply(t, n, o);
            })(e, t, n, o);
          },
          remove: (t, n, o, r) => {
            ((e, t, n, o, r) => {
              iw(e).formatter.remove(t, n, o, r);
            })(e, t, n, o, r);
          },
          toggle: (t, n, o) => {
            ((e, t, n, o) => {
              iw(e).formatter.toggle(t, n, o);
            })(e, t, n, o);
          },
          match: (t, n, o, r) =>
            ((e, t, n, o, r) => iw(e).formatter.match(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          closest: (t) => ((e, t) => iw(e).formatter.closest(t))(e, t),
          matchAll: (t, n) =>
            ((e, t, n) => iw(e).formatter.matchAll(t, n))(e, t, n),
          matchNode: (t, n, o, r) =>
            ((e, t, n, o, r) => iw(e).formatter.matchNode(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          canApply: (t) => ((e, t) => iw(e).formatter.canApply(t))(e, t),
          formatChanged: (t, o, r, s) =>
            ((e, t, n, o, r, s) =>
              iw(e).formatter.formatChanged(t, n, o, r, s))(e, n, t, o, r, s),
          getCssText: T(mE, e),
        }
      );
    },
    ...
    pE = (e) => {
      const t = Dr(),
        ...
        r = {
          ...
          beforeChange: () => {
            ((e, t, n) => {
              iw(e).undoManager.beforeChange(t, n);
            })(e, n, t);
          },
          add: (s, a) =>
            ((e, t, n, o, r, s, a) => iw(e).undoManager.add(t, n, o, r, s, a))(
              e,
              r,
              o,
              n,
          ...
          undo: () =>
            ((e, t, n, o) => iw(e).undoManager.undo(t, n, o))(e, r, n, o),
          redo: () => ((e, t, n) => iw(e).undoManager.redo(t, n))(e, o, r.data),
          clear: () => {
            ((e, t, n) => {
              iw(e).undoManager.clear(t, n);
            })(e, r, o);
          },
          reset: () => {
            ((e, t) => {
              iw(e).undoManager.reset(t);
            })(e, r);
          },
          hasUndo: () =>
            ((e, t, n) => iw(e).undoManager.hasUndo(t, n))(e, r, o),
          hasRedo: () =>
            ((e, t, n) => iw(e).undoManager.hasRedo(t, n))(e, r, o),
          transact: (t) =>
            ((e, t, n, o) => iw(e).undoManager.transact(t, n, o))(e, r, n, t),
          ignore: (t) => {
            ((e, t, n) => {
              iw(e).undoManager.ignore(t, n);
            })(e, n, t);
          },
          extra: (t, n) => {
            ((e, t, n, o, r) => {
              iw(e).undoManager.extra(t, n, o, r);
            })(e, r, o, t, n);
          },
        };
      return (
            ...
            e.on("init", () => {
              ...
              e.on("keydown", (e) => {
                ...
                if (
                  ...
                  return (
                    t.beforeChange(), nw(t, !0, n), t.add({}, e), void o.set(!0)
                  );
    ...
    bE = "data-mce-placeholder",
    vE = (e) => "keydown" === e.type || "keyup" === e.type,
    yE = (e) => {
      const t = e.keyCode;
    ...
    EE = (e, t) =>
      Jn(
        ...
        .getOr(e),
    xE = (e, t, n) => {
      const o = n ? Ln(e).reverse() : Mn(e),
        r = J(o, (e) => t.isBlock($t(e))).fold(N(o), (e) => o.slice(0, e));
      return n ? r.reverse() : r;
    },
    kE = (e, t, n, o, r) => {
      const s = ((e, t, n, o, r) => {
        if (r && Sn(e, t)) return xE(t, n, o);
        if (r && Sn(t, e)) return xE(e, n, o);
        {
          const e = In(t);
          return J(e, (e) => n.isBlock($t(e))).fold(N(e), (t) => e.slice(0, t));
        }
      })(e, t, n, o, r);
      return q(s, xo), s;
    },
    _E = (e, t, n) => {
      const o = zp(n, t);
      return Q(o.reverse(), (t) => Tr(e, t)).each(xo);
    },
    SE = (e, t, n, o, r, s) => {
      if (Tr(o, n)) return Za(n), Hu(n.dom);
      ((e, t) => 0 === Y(Ln(t), (t) => !Tr(e, t)).length)(o, s) &&
        Tr(o, t) &&
        ho(s, vn("br"));
      const a = ju(n.dom, Qi.before(s.dom));
      return (
        q(kE(n, t, o, r, !1), (e) => {
          ho(s, e);
        }),
    ...
    NE = (e, t, n, o, r) => {
      if (Tr(o, n)) {
        ...
        return xo(n), Hu(t.dom);
      }
      const s = $u(n.dom);
      return (
        q(kE(n, t, o, r, !0), (e) => {
          r && Sn(t, n) ? vo(n, e) : yo(n, e);
        }),
        _E(o, e, t),
        s
      );
    ...
    AE = (e, t, n, o, r) => (
      ...
      ((e, t) =>
        Sn(t, e)
          ...
          : I.none())(t, n).fold(T(NE, e, t, n, o, r), T(SE, e, t, n, o, r))
    ),
    TE = (e, t, n, o, r, s = !1) => {
      if (s) {
        if (Sn(o, n)) return AE(e, o, n, r, !t);
        if (Sn(n, o)) return AE(e, n, o, r, t);
      }
      return t ? AE(e, o, n, r, t) : AE(e, n, o, r, !t);
    },
    OE = (e, t) => {
      const n = Cn(e.getBody()),
        o = ((e, t, n, o) =>
          o.collapsed
            ? ((e, t, n, o) => {
                const r = wE(t, Qi.fromRangeStart(o)),
                  s = r.bind((o) =>
                ...
                return It(r, s, CE).filter(
                  (e) =>
                    ((e) => !_n(e.from.block, e.to.block))(e) &&
                    ((e, t) => {
                      const n = Cn(e);
                      return _n(EE(n, t.from.block), EE(n, t.to.block));
                    })(t, e) &&
                    ((e) =>
          ...
          (o) => () => {
            TE(n, t, o.from.block, o.to.block, e.schema, !0).each((t) => {
    ...
    PE = (e) => {
      ...
      return ((e, t) => {
        ...
        return (
          !((e, t) => BE(e, t.startContainer) || BE(e, t.endContainer))(e, t) &&
          n &&
          o
        );
    ...
    DE = (e, t) => (e.selection.isCollapsed() ? I.none() : PE(e)),
    LE = (e, t, n, o, r) => I.from(t._selectionOverrides.showCaret(e, n, o, r)),
    ME = (e, t) =>
      ...
      t.collapsed
        ? ((e, t, n) => {
            const o = pu(1, e.getBody(), t),
              ...
              s = r.getNode();
            if (Wc(s)) return LE(1, e, s, !r.isAtEnd(), !1);
            const a = r.getNode(!0);
            if (Wc(a)) return LE(1, e, a, !1, !1);
            const i = pb(e.dom.getRoot(), r.getNode());
            return Wc(i) ? LE(1, e, i, !1, n) : I.none();
          })(e, t, n).getOr(t)
        : t,
    FE = (e) => Ip(e) || Pp(e),
    UE = (e) => Fp(e) || Dp(e),
    zE = (e, t, n, o, r, s) => {
      LE(o, e, s.getNode(!r), r, !0).each((n) => {
        if (t.collapsed) {
    ...
    jE = (e, t) =>
      ((e, t) => {
        ...
        if (a(d)) return I.some(() => zE(e, n, i.getNode(), o, t, d));
        const c = s(d);
        return c && a(c) && Cu(d, c)
          ? I.some(() => zE(e, n, i.getNode(), o, t, c))
          : I.none();
      })(e, t),
    HE = (e, t) => {
      const n = e.getBody();
    ...
    $E = (e) => {
      ...
      return (
        !t.collapsed &&
        (HE(e, !0).exists((e) => e.isEqual(Qi.fromRangeStart(t))) ||
          HE(e, !1).exists((e) => e.isEqual(Qi.fromRangeEnd(t))))
      );
    },
    VE = xl([
      { remove: ["element"] },
          ...
          ((e, t, n, o, r) => {
            ...
            ? ((e, t, n, o, r) => {
                ...
                return Fh(Cn(t), Cn(o.getNode()))
                  .map((t) =>
                    Tr(e, t) ? VE.remove(t.dom) : VE.moveToElement(s)
                  )
                  .orThunk(() => I.some(VE.moveToElement(s)));
              })(o, e, t, n, r)
            : (t && Fp(n)) || (!t && Ip(n))
            ? I.some(VE.moveToPosition(r))
            : I.none()
        );
        var s;
      }),
    WE = (e, t) => I.from(pb(e.getBody(), t)),
    KE = (e, t) => {
          ...
          () =>
            ((e, t, n, o) => {
              const r = pu(t ? 1 : -1, e, n),
                ...
                a = Cn(e);
              return !t && Fp(s)
                ? I.some(VE.remove(s.getNode(!0)))
                : t && Ip(s)
                ? I.some(VE.remove(s.getNode()))
                : !t && Ip(s) && Qp(a, s, o)
                ? Jp(a, s, o).map((e) => VE.remove(e.getNode()))
                : t && Fp(s) && Zp(a, s, o)
                ? eh(a, s, o).map((e) => VE.remove(e.getNode()))
                : ((e, t, n, o) =>
                    ((e, t) => {
                      const n = t.getNode(!e),
                        o = e ? "after" : "before";
                      ...
                      ? ((e, t) =>
                          y(t)
                            ? I.none()
                            : e && vr(t.nextSibling)
                            ? I.some(VE.moveToElement(t.nextSibling))
                            : !e && vr(t.previousSibling)
                            ? I.some(VE.moveToElement(t.previousSibling))
                      ...
                      : qE(e, t, n, o).bind((t) =>
                          ((e, t, n) =>
                            n.fold(
                              (e) => I.some(VE.remove(e)),
                              (e) => I.some(VE.moveToElement(e)),
                              (n) =>
                                lu(t, n, e)
                                  ? I.none()
                                  : I.some(VE.moveToPosition(n))
                            ))(e, n, t)
                        ))(e, t, s, o);
                  ...
                  .fold(
                    () =>
                      I.some(() => {
                        var n;
                        (n = Cn(e.getBody())),
                          q(zo(n, ".mce-offscreen-selection"), xo),
    ...
    XE = (e) => e.hasOwnProperty("text"),
    ZE = (e) => e.hasOwnProperty("marker"),
    QE = (e, t) => {
      const n = (e, n) => {
          if (dr(e)) return { text: e, offset: n };
          {
            const o = t(),
              r = e.childNodes;
            return n < r.length
    ...
    tx = (e, t) =>
      e.selection.isCollapsed()
        ...
        : I.none(),
    nx = dr,
    ox = (e) => nx(e) && e.data[0] === Qa,
    rx = (e) => nx(e) && e.data[e.data.length - 1] === Qa,
    sx = (e) => {
      var t;
      return (
    ...
    ax = (e, t) =>
      e
        ? ((e) => {
            var t;
            if (nx(e.previousSibling))
              return (
                rx(e.previousSibling) || e.previousSibling.appendData(Qa),
                e.previousSibling
              );
            if (nx(e)) return ox(e) || e.insertData(0, Qa), e;
            {
              const n = sx(e);
              return (
                null === (t = e.parentNode) ||
        ...
        : ((e) => {
            ...
            if (nx(e.nextSibling))
              return (
                ox(e.nextSibling) || e.nextSibling.insertData(0, Qa),
                e.nextSibling
              );
            if (nx(e)) return rx(e) || e.appendData(Qa), e;
            {
              const o = sx(e);
              return (
                e.nextSibling
    ...
    lx = T(ax, !1),
    dx = (e, t) =>
      dr(e.container()) ? ax(t, e.container()) : ax(t, e.getNode()),
    cx = (e, t) => {
      const n = t.get();
    ...
    hx = (e, t) => null === Wu(e, t),
    bx = (e, t, n) => Th(e, t, n).filter(T(hx, t)),
    vx = (e, t, n) => {
      const o = Ph(n);
      return bx(e, t, o).bind((e) =>
        ju(e, o).isNone() ? I.some(fx.start(e)) : I.none()
      );
    },
    yx = (e, t, n) => {
      const o = Bh(n);
      return bx(e, t, o).bind((e) =>
        zu(e, o).isNone() ? I.some(fx.end(e)) : I.none()
      );
    },
    Cx = (e, t, n) => {
      const o = Ph(n),
    ...
    wx = (e) => !Ah(xx(e)),
    Ex = (e, t, n) => mx([px, vx, yx, Cx], [e, t, n]).filter(wx),
    xx = (e) => e.fold(R, R, R, R),
    kx = (e) => e.fold(N("before"), N("start"), N("end"), N("after")),
    _x = (e) => e.fold(fx.before, fx.before, fx.after, fx.after),
    Sx = (e) => e.fold(fx.start, fx.start, fx.end, fx.end),
    Nx = (e, t, n, o, r, s) =>
    ...
    Rx = (e, t) =>
      e.fold(M, (e) => {
        return (o = t), !(kx((n = e)) === kx(o) && xx(n) === xx(o));
        var n, o;
      }),
    Ax = (e, t) =>
      e
        ? t.fold(_(I.some, fx.start), I.none, _(I.some, fx.after), I.none)
        : t.fold(I.none, _(I.some, fx.before), I.none, _(I.some, fx.end)),
    Tx = (e, t, n) => {
      const o = e ? 1 : -1;
      return (
  ...
  const Bx = (e, t) => (e === wu.Backwards ? oe(t) : t),
    Px = (e, t, n) => (e === wu.Forwards ? t.next(n) : t.prev(n)),
    Dx = (e, t, n, o) =>
      ...
      for (; s; ) {
        ...
        if (pr(n.getNode(!1)))
          return t === wu.Forwards
            ? {
                positions: Bx(t, a).concat([n]),
                breakType: Ox.Br,
                breakAt: I.some(n),
              }
            : { positions: Bx(t, a), breakType: Ox.Br, breakAt: I.some(n) };
        if (n.isVisible()) {
          if (e(s, n)) {
            const e = Dx(0, t, s, n);
            return { positions: Bx(t, a), breakType: e, breakAt: I.some(n) };
          }
          a.push(n), (s = n);
        } else s = n;
      }
      return { positions: Bx(t, a), breakType: Ox.Eol, breakAt: I.none() };
    },
    Mx = (e, t, n, o) =>
      t(n, o)
        .breakAt.map((o) => {
    ...
    Fx = (e, t) => le(t.getClientRects()).bind((t) => Ix(e, t.left)),
    Ux = T(Lx, Qi.isAbove, -1),
    zx = T(Lx, Qi.isBelow, 1),
    jx = T(Mx, -1, Ux),
    Hx = T(Mx, 1, zx),
    $x = (e, t) => Ux(e, t).breakAt.isNone(),
    Vx = (e, t) => zx(e, t).breakAt.isNone(),
    qx = (e, t) => Fx(jx(e, t), t),
    Wx = (e, t) => Fx(Hx(e, t), t),
    Kx = vr,
    Yx = (e, t) => Math.abs(e.left - t),
    Gx = (e, t) => Math.abs(e.right - t),
    Xx = (e, t) =>
      Be(e, (e, n) => {
        const o = Math.min(Yx(e, t), Gx(e, t)),
          r = Math.min(Yx(n, t), Gx(n, t));
        return (r === o && _e(n, "node") && Kx(n.node)) || r < o ? n : e;
      }),
    Zx = (e) => {
      const t = (t) =>
        V(t, (t) => {
  ...
  const ek = (e, t, n, o, r, s) => {
    ...
    lk = (e, t, n, o, r, s) => {
      ...
      if (!n.collapsed) {
        const o = Ci(n);
        if (s(o)) return LE(t, e, o, t === wu.Backwards, !1);
        if ($E(e)) {
      ...
      if (d(c)) return ME(e, c.getNode(!a));
      let u = l(c);
      const m = mi(n);
      if (!u) return m ? I.some(n) : I.none();
      if (((u = Oh(a, u)), d(u))) return LE(t, e, u.getNode(!a), a, !1);
      const f = l(u);
      return f && d(f) && Cu(u, f)
        ? LE(t, e, f.getNode(!a), a, !1)
        : m
        ? ik(e, u.toRange(), !1)
        : I.none();
    },
    dk = (e, t, n, o, r, s) => {
      ...
      if (((g = o(a) ? a.getNode() : r(a) ? a.getNode(!0) : Ci(n)), g)) {
        ...
        let o = Xx(Y(n, sk(1)), m);
        if (o) return ik(e, o.position.toRange(), !1);
        if (((o = De(Y(n, sk(0)))), o)) return ik(e, o.position.toRange(), !1);
      }
      return 0 === u.length
        ? ck(e, l)
            .filter(l ? r : o)
            .map((t) => IE(e, t.toRange(), !1))
        : I.none();
    },
    ck = (e, t) => {
      const n = e.selection.getRng(),
    ...
    gk = (e, t, n) => ux(t, n).map((t) => (mk(e, t), n)),
    pk = (e, t, n) => {
      const o = e.getBody(),
        r = ((e, t, n) => {
          ...
          .orThunk(() =>
            ((e, t, n, o, r) => {
              ...
              return Mu(e, n, s)
                ...
                .fold(
                  () => o.map(_x),
                  (r) => Ex(t, n, r).map(T(Nx, e, t, n, s, r)).filter(T(Rx, o))
                )
                .filter(wx);
            })(e, t, n, s, o)
          );
      })(n, T(Rh, e), o, r).bind((n) => gk(e, t, n));
    },
    hk = (e, t, n) => !!Nd(e) && pk(e, t, n).isSome(),
    bk = (e, t, n) =>
      !!Nd(t) &&
      ((e, t) => {
          ...
          Nd(e) &&
            (((e, t, n) => {
              const o = V(
                ...
                r = Y(o, e),
                s = Y(n, e);
              q(re(r, s), T(fk, !1)), q(re(s, r), T(fk, !0));
            })(n, e.dom, o.parents),
            ((e, t) => {
              const n = t.get();
            ...
            ((e, t, n, o) => {
              if (t.selection.isCollapsed()) {
                ...
                q(r, (o) => {
                  ...
                  Ex(e, t.getBody(), r).bind((e) => gk(t, n, e));
                });
              }
            })(n, e, t, o.parents));
        }),
    ...
    wk = (e, t, n) => {
      if (Nd(e)) {
        const o = ck(e, t).getOrThunk(() => {
          const n = e.selection.getRng();
          return t ? Qi.fromRangeEnd(n) : Qi.fromRangeStart(n);
        });
        return Ex(T(Rh, e), e.getBody(), o).exists((t) => {
          const o = _x(t);
          return ux(n, o).exists((t) => (mk(e, t), !0));
        });
      }
      return !1;
    },
    Ek = (e, t) => (n) => ux(t, n).map((t) => () => mk(e, t)),
    xk = (e, t, n, o) => {
      const r = e.getBody(),
        s = T(Rh, e);
      e.undoManager.ignore(() => {
        e.selection.setRng(
          ...
          Lh(e),
          Ex(s, r, Qi.fromRangeStart(e.selection.getRng()))
            .map(Sx)
            .bind(Ek(e, t))
            .each(D);
      }),
      ...
      if (e.selection.isCollapsed() && Nd(e)) {
        ...
        return ((e, t, n, o) => {
          ...
          return a
            .bind((e) =>
              n
                ? e.fold(N(I.some(Sx(e))), I.none, N(I.some(_x(e))), I.none)
                : e.fold(I.none, N(I.some(_x(e))), I.none, N(I.some(Sx(e))))
            )
            .map(Ek(e, t))
            .getOrThunk(() => {
              const i = Iu(n, r, o),
    ...
    Rk = (e) => {
      const t = ((e) => _k(e, (t) => e.schema.isBlock($t(t))))(e);
      return Nk(e, t);
    },
    Ak = (e, t) => {
      const n = Y(
        ((e) => _k(e, (t) => e.schema.isBlock($t(t)) || ((e) => jn(e) > 1)(t)))(
          e
        ),
        Sk
      );
    ...
    Ok = (e) => dr(e.startContainer),
    Bk = (e) => {
      const t = e.selection.getRng();
      return (
        ((e) => 0 === e.startOffset && Ok(e))(t) &&
        ((e, t) => {
          const n = t.startContainer.parentElement;
          return !h(n) && av(e, Cn(n));
        })(e, t) &&
        ((e) =>
          ((e) =>
            ((e) => {
    ...
    Dk = (e) => (
      ((e) => {
        ...
        return (
          t.collapsed &&
          (Ok(t) || e.dom.isEmpty(t.startContainer)) &&
          !((e) => {
            return (
      ...
      e.selection.isCollapsed()
        ? ((e, t) => {
            ...
            return n(r)
              ...
              : I.from(Oh(t, r))
                  .filter((e) => n(e) && Cu(r, e))
                  .bind((n) => Lk(e, t, n.getNode(!t)));
          })(e, t)
        : ((e, t) => {
            const n = e.selection.getNode();
            return wr(n) ? Lk(e, t, n) : I.none();
          })(e, t),
    Ik = (e) => Ze(null != e ? e : "").getOr(0),
    Fk = (e, t) =>
    ...
    $k = (e) => Hk(e, "outdent"),
    Vk = (e) => {
      if (e.selection.isCollapsed() && Uk(e)) {
        const t = e.dom,
          n = e.selection.getRng(),
          o = Qi.fromRangeStart(n),
          r = t.getParent(n.startContainer, t.isBlock);
        if (null !== r && qp(Cn(r), o, e.schema)) return I.some(() => $k(e));
      }
      return I.none();
    },
    qk = (e, t, n) =>
      ue([Vk, GE, jE, (e, n) => kk(e, t, n), OE, gb, tx, Mk, DE, Pk, ex], (t) =>
        t(e, n)
    ...
    Wk = (e) =>
      void 0 === e.touches || 1 !== e.touches.length
        ? I.none()
        : I.some(e.touches[0]),
    Kk = (e, t) => ke(e, t.nodeName),
    Yk = (e, t) =>
      !!dr(t) ||
      (!!er(t) && !(Kk(e.getBlockElements(), t) || rm(t) || Zr(e, t) || Ir(t))),
    Gk = (e, t) => {
      if (dr(t)) {
        if (0 === t.data.length) return !0;
        if (/^\s+$/.test(t.data))
          return !t.nextSibling || Kk(e, t.nextSibling) || Ir(t.nextSibling);
      }
      return !1;
    },
    Xk = (e) => e.dom.create(ql(e), Wl(e)),
    Zk = (e, t, n) => {
      const o = Cn(Xk(e)),
        r = Xa();
      yo(o, r), n(t, o);
    ...
    Qk = (e) => (t) => -1 !== (" " + t.attr("class") + " ").indexOf(e),
    Jk = (e, t, n) =>
      function (o) {
        const r = arguments,
          s = r[r.length - 2],
    ...
    n_ = (e, t) => {
      ...
      if (n)
        return "compositionstart" === t.type
          ? (t.preventDefault(), t.stopPropagation(), void t_(e, n))
          : void (ai(n) && (t_(e, n), e.undoManager.add()));
    },
    o_ = vr,
    r_ = (e, t, n) => {
    ...
    s_ = (e, t) =>
      ((e, t) => {
        const n = t ? wu.Forwards : wu.Backwards,
          o = e.selection.getRng();
        return ((e, t, n) => lk(t, e, n, Ip, Fp, o_))(n, e, o).orThunk(
          () => (r_(e, n, o), I.none())
        );
      })(
        e,
      ...
      ((e, t) => {
        ...
        return ((e, t, n) =>
          dk(
            ...
            (e) => Fp(e) || Mp(e),
            o_
          ))(n, e, o).orThunk(() => (r_(e, n, o), I.none()));
      })(e, t).exists((t) => (ak(e, t), !0)),
    i_ = (e, t) => uk(e, t, t ? Fp : Ip),
    l_ = (e, t) =>
      HE(e, !t)
        .map((n) => {
          const o = n.toRange(),
    ...
    c_ = (e, t) =>
      ...
      ((e, t) => {
        ...
        return ((e, t, n) => {
          const o = T(_n, t);
          return Jn(Cn(e.container()), (e) => n.isBlock($t(e)), o).filter(d_);
        })(o, n, e.schema).exists(() => {
          if (((e, t, n) => (t ? Vx(e.dom, n) : $x(e.dom, n)))(n, t, o)) {
            const o = Zk(e, n, t ? yo : vo);
      ...
      ((e, t) =>
        t
          ...
          : I.from(e.dom.getParent(e.selection.getNode(), "summary"))
              ...
              .getOr(!1))(e, t),
    m_ = { shiftKey: !1, altKey: !1, ctrlKey: !1, metaKey: !1, keyCode: 0 },
    f_ = (e, t) =>
      t.keyCode === e.keyCode &&
    ...
    b_ = (e, t) => {
      const n = t ? wu.Forwards : wu.Backwards,
        o = e.selection.getRng();
      return lk(e, n, o, Pp, Dp, wr).exists((t) => (ak(e, t), !0));
    },
    v_ = (e, t) => {
      const n = t ? 1 : -1,
        o = e.selection.getRng();
      return dk(e, n, o, Pp, Dp, wr).exists((t) => (ak(e, t), !0));
    },
    y_ = (e, t) => uk(e, t, t ? Dp : Pp),
    C_ = xl([
      { none: ["current"] },
      { first: ["current"] },
    ...
    w_ = { ...C_, none: (e) => C_.none(e) },
    E_ = (e, t, n) =>
      te(In(e), (e) => (xn(e, t) ? (n(e) ? [e] : []) : E_(e, t, n))),
    x_ = (e, t) => oo(e, "table", t),
    k_ = (e, t, n, o, r = M) => {
      const s = 1 === o;
      if (!s && n <= 0) return w_.first(e[0]);
      if (s && n >= e.length - 1) return w_.last(e[e.length - 1]);
      {
        const s = n + o,
          a = e[s];
        return r(a) ? w_.middle(t, a) : k_(e, t, s, o, r);
      }
    },
    __ = (e, t) =>
      x_(e, t).bind((t) => {
        const n = E_(t, "th,td", M);
    ...
    O_ = (e, t, n) => {
      const o = e(t, n);
      return ((e) => e.breakType === Ox.Wrap && 0 === e.positions.length)(o) ||
        (!pr(n.getNode()) &&
          ((e) => e.breakType === Ox.Br && 1 === e.positions.length)(o))
    ...
    M_ = (e, t, n, o) => {
      ...
      if (!t && B_(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            le(t.getClientRects())
              .bind((t) => A_(e, t.left, t.top))
              .bind((e) => {
                return Fx(
                  $u((n = e))
                    .map((e) => Ux(n, e).positions.concat(e))
                    .getOr([]),
                  t
                );
                var n;
          ...
          ((e, t) =>
            de(t.getClientRects())
              ...
              .bind((e) => {
                return Fx(
                  Hu((n = e))
                    .map((e) => [e].concat(zx(n, e).positions))
                    .getOr([]),
                  t
                );
                var n;
            ...
            .orThunk(() =>
              le(n.getClientRects()).bind((n) => Ix(Hx(e, Qi.after(t)), n.left))
            )
    ...
    z_ = (e, t, n) =>
      n.fold(
        ...
        (n) => (e.execCommand("mceTableInsertRowAfter"), j_(e, t, n))
      ),
    j_ = (e, t, n) => {
      return z_(
        e,
    ...
    V_ = (e, t) => ({ container: e, offset: t }),
    q_ = ma.DOM,
    W_ = (e) => (t) => e === t ? -1 : 0,
    K_ = (e, t, n) => {
      if (dr(e) && t >= 0) return I.some(V_(e, t));
      {
        const o = Ua(q_);
        return I.from(o.backwards(e, t, W_(e), n)).map((e) =>
          V_(e.container, e.container.data.length)
        );
      }
    },
    Y_ = (e, t, n) => {
      ...
      const o = e.data;
      if (t >= 0 && t <= o.length) return I.some(V_(e, t));
      {
        const o = Ua(q_);
        return I.from(o.backwards(e, t, W_(e), n)).bind((e) => {
          const o = e.container.data;
          return Y_(e.container, t + o.length, n);
        });
      }
    },
    G_ = (e, t, n) => {
      if (!dr(e)) return I.none();
      const o = e.data;
      if (t <= o.length) return I.some(V_(e, t));
      {
        const r = Ua(q_);
        return I.from(r.forwards(e, t, W_(e), n)).bind((e) =>
          G_(e.container, t - o.length, n)
        );
      }
    },
    X_ = (e, t, n, o, r) => {
    ...
    eS = (e) => {
      if (((e) => 3 === e.nodeType)(e)) return V_(e, e.data.length);
      {
        const t = e.childNodes;
        return t.length > 0 ? eS(t[t.length - 1]) : V_(e, t.length);
      }
    },
    tS = (e, t) => {
      const n = e.childNodes;
        ...
        i = Y(
          ...
          (t) =>
            ...
            t.matches.getOrThunk(() =>
              ((e) => (t) => {
                const n = tS(t.startContainer, t.startOffset);
                return !((e, t) => {
                  var n;
                  const o =
  ...
  const rS = (e, t, n) => (e.stype === oS.Error ? t(e.serror) : n(e.svalue)),
    sS = (e) => ({ stype: oS.Value, svalue: e }),
    aS = (e) => ({ stype: oS.Error, serror: e }),
    iS = rS,
    lS = (e) =>
      f(e) && fe(e).length > 100
        ? " removed due to size"
        : JSON.stringify(e, null, 2),
    dS = (e, t) => aS([{ path: e, getErrorInfo: t }]),
    cS = (e, t) => ({
      extract: (n, o) =>
        xe(o, e).fold(
          () =>
    ...
    mS = uS((e, t) => (g(e) && g(t) ? mS(e, t) : t)),
    fS = uS((e, t) => t),
    gS = (e) => ({ tag: "defaultedThunk", process: N(e) }),
    pS = (e) => {
      const t = ((e) => {
        const t = [],
          n = [];
    ...
    vS = bS(sS),
    yS = (e, t, n, o) => o(xe(e, t).getOrThunk(() => n(e))),
    CS = (e, t, n, o, r) => {
    ...
    SS = (e, t) =>
      bS((n) => {
        const o = typeof n;
        return e(n) ? sS(n) : aS(`Expected type: ${t} but got: ${o}`);
      }),
    NS = SS(E, "number"),
    RS = SS(m, "string"),
    AS = SS(b, "boolean"),
    ...
    PS = (e, t) => OS(e, e, { tag: "required", process: {} }, t),
    DS = (e) => PS(e, RS),
    LS = (e) => PS(e, TS),
    MS = (e, t) => OS(e, e, { tag: "option", process: {} }, t),
    IS = (e) => MS(e, RS),
    FS = (e, t, n) => OS(e, e, gS(t), n),
    US = (e, t) => FS(e, t, NS),
    zS = (e, t, n) =>
      FS(
        e,
    ...
    QS = jS("enabled", !0),
    JS = jS("primary", !1),
    eN = (e) => ((e, t) => FS("type", t, RS))(0, e),
    tN = wS([
      $S,
      DS("trigger"),
      US("minChars", 1),
      (1, ((e, t) => OS(e, e, gS(1), _S()))("columns")),
      US("maxResults", 10),
      ("matches", MS("matches", TS)),
      VS,
      qS,
      ((nN = RS), FS("highlightOn", [], ES(nN))),
    ]);
  var nN;
  const oN = [QS, GS, YS, KS, WS],
    rN = [ZS].concat(oN),
    sN = [
      HS("predicate", L),
      zS("scope", "node", ["node", "editor"]),
      zS("position", "selection", ["node", "selection", "line"]),
    ],
    aN = oN.concat([eN("contextformbutton"), JS, qS, BS("original", R)]),
    iN = rN.concat([eN("contextformbutton"), JS, qS, BS("original", R)]),
    lN = oN.concat([eN("contextformbutton")]),
    dN = rN.concat([eN("contextformtogglebutton")]),
    cN = kS("type", { contextformbutton: aN, contextformtogglebutton: iN });
  wS(
    [
      eN("contextform"),
      HS("initValue", N("")),
      XS,
      ((e, t) => OS(e, e, { tag: "required", process: {} }, ES(t)))(
        "commands",
        cN
      ),
      MS(
        "launch",
        kS("type", { contextformbutton: lN, contextformtogglebutton: dN })
      ),
    ].concat(sN)
  );
  const uN = (e) => {
      const t = e.ui.registry.getAll().popups,
        n = he(t, (e) => {
          return ((t = e), xS("Autocompleter", tN, t)).fold((e) => {
            throw new Error(
              "Errors: \n" +
                ((e) => {
                  const t =
        ...
        a = (a) => {
          ((n) =>
            t
              .get()
              .map((t) =>
                J_(e.dom, e.selection.getRng(), t.trigger, !0).bind((t) =>
                  nS(e, s, t, n)
                )
              )
              .getOrThunk(() =>
                ((e, t) => {
                  const n = t(),
                    o = e.selection.getRng();
                  return ((e, t, n) => ue(n.triggers, (n) => J_(e, t, n)))(
                    e.dom,
                    o,
                    n
                  ).bind((n) => nS(e, t, n));
    ...
    hN = (e, t) => I.from(e.getParent(t.container(), "details")),
    bN = (e, t) => hN(e, t).isSome(),
    vN = (e, t) => {
      const n = t.getNode();
      ...
      if ("character" === n) {
        ...
        return (
          !!(
            l &&
            (t ? c : d) &&
            Iu(!t, s, n).exists((e) => bN(o, e) && !Mt(i, hN(o, e)))
          ) ||
          Iu(t, s, n).fold(L, (n) => {
            const r = hN(o, n);
            if (bN(o, n) && !Mt(i, r)) {
    ...
    SN = xt(),
    NN = SN.os,
    RN = NN.isMacOS() || NN.isiOS(),
    AN = SN.browser.isFirefox(),
    TN = (e, t) => {
      const n = e.dom,
    ...
    FN = (e) => C(e) && /^(LI|DT|DD)$/.test(e.nodeName),
    UN = (e) => {
      const t = e.parentNode;
      return FN(t) ? t : e;
    },
    ...
    HN = (e, t) => t && "A" === t.nodeName && e.isEmpty(t),
    $N = (e, t) =>
      e.nodeName === t ||
      ...
      insert: (e, t) => {
        ...
        E ||
          (n = ((e, t, n, o, r) => {
            var s, a;
            const i = e.dom,
              l = null !== (s = ON(i, o)) && void 0 !== s ? s : i.getRoot();
        ...
        if (/^(LI|DT|DD)$/.test(r) && er(s) && i.isEmpty(_))
          return void ((e, t, n, o, r) => {
            ...
            const d = FN(o) ? jN(o) : void 0;
            let c = FN(o) && d ? t(r, { style: jN(o) }) : t(r);
            if (zN(n, o, !0) && zN(n, o, !1))
              if (MN(n, "LI")) {
                const e = UN(n);
                s.insertAfter(c, e),
                  ((e) => {
              ...
              MN(n, "LI")
                ? (s.insertAfter(c, UN(n)),
                  c.appendChild(s.doc.createTextNode(" ")),
                  c.appendChild(n))
                : i.insertBefore(c, n),
                s.remove(o);
            else if (zN(n, o, !1)) s.insertAfter(c, UN(n)), s.remove(o);
            else {
              n = UN(n);
        ...
        if (!(p || (_ !== e.getBody() && VN(i, _)))) return;
        ...
        if (p)
        ...
        else if (oi(_)) (R = ui(_)), i.isEmpty(_) && PN(_), DN(e, R), TN(e, R);
        else if (v(!1)) R = w();
        else if (v(!0) && N) {
          ...
          const t = ((e) => {
            ...
            return (
              t.setStart(
                e.startContainer,
                qN(!0, e.startContainer, e.startOffset)
              ),
              t.setEnd(e.endContainer, qN(!1, e.endContainer, e.endOffset)),
              t
            );
          })(d).cloneRange();
          t.setEndAfter(_);
          ...
          ((e) => {
            ...
            i.isEmpty(_) && PN(_),
            R.normalize(),
            i.isEmpty(R) ? (i.remove(R), w()) : (DN(e, R), TN(e, R));
        }
    ...
    GN = (e, t) => {
      XN(e.getBody(), t) || bo(Cn(t), vn("br"));
      const n = vn("br");
      bo(Cn(t), n), KN(e, n.dom, !1), e.undoManager.add();
    },
    XN = (e, t) => {
      return (
        (n = Qi.after(t)),
    ...
    ZN = (e) => e && "A" === e.nodeName && "href" in e,
    QN = (e) => e.fold(L, ZN, ZN, L),
    JN = (e, t) => {
      t.fold(k, T(YN, e), T(GN, e), k);
    },
    eR = {
      insert: (e, t) => {
        const n = ((e) => {
          ...
          return Ex(t, e.getBody(), n).filter(QN);
        })(e);
        n.isSome()
          ? n.each(T(JN, e))
          : ((e, t) => {
    ...
    aR = (e) => {
      const t = ON(e.dom, e.selection.getStart());
      return y(t);
    },
    iR = (e) => sR("pre", e),
    lR = (e) => (t, n) => Vl(t) === e,
    dR = (e, t) => ((e) => tR(e, Yl(e)))(e),
    cR = (e, t) => t,
    uR = (e) => {
      const t = ql(e),
        n = ON(e.dom, e.selection.getStart());
    ...
    gR = (e, t, n) => {
      t.selection.isCollapsed() ||
        ...
        (C(n) && _N(t, e.fakeEventName).isDefaultPrevented()) ||
          (e.insert(t, n), C(n) && kN(t, e.fakeEventName));
    },
    pR = (e, t) => {
      const n = () => gR(eR, e, t),
        o = () => gR(WN, e, t),
        r = ((e, t) =>
          mx(
            [
              fR([oR], nR.none()),
              fR([iR(!0), aR], nR.none()),
              fR([sR("summary", !0)], nR.br()),
              fR([iR(!0), lR(!1), cR], nR.br()),
              fR([iR(!0), lR(!1)], nR.block()),
              fR([iR(!0), lR(!0), cR], nR.block()),
              fR([iR(!0), lR(!0)], nR.br()),
              fR([rR(!0), cR], nR.br()),
              fR([rR(!0)], nR.block()),
              fR([dR], nR.br()),
    ...
    hR = xt(),
    bR = hR.os.isiOS() && hR.browser.isSafari(),
    vR = (e, t) => {
      var n;
    ...
    yR = xt(),
    CR = (e) => e.stopImmediatePropagation(),
    wR = (e) => e.keyCode === yf.PAGE_UP || e.keyCode === yf.PAGE_DOWN,
    ER = (e, t, n) => {
      n && !e.get()
        ? t.on("NodeChange", CR, !0)
        : !n && e.get() && t.off("NodeChange", CR),
        e.set(n);
    },
    xR = (e, t) => {
      const n = t.container(),
    ...
    AR = (e) =>
      kc(e)
        ? [
            { keyCode: yf.TAB, action: g_($_, e, !0) },
            { keyCode: yf.TAB, shiftKey: !0, action: g_($_, e, !1) },
          ]
        : [],
    TR = (e) => {
      if ((e.addShortcut("Meta+P", "", "mcePrint"), mN(e), sw(e)))
        return Br(null);
      {
        const t = vk(e);
        return (
          ...
          ((e) => {
            e.on("keyup compositionstart", T(n_, e));
          })(e),
          ((e, t) => {
            e.on("keydown", (n) => {
              n.isDefaultPrevented() ||
                ((e, t, n) => {
                  ...
                  p_(
                    [
                      { keyCode: yf.RIGHT, action: g_(s_, e, !0) },
                      { keyCode: yf.LEFT, action: g_(s_, e, !1) },
                      { keyCode: yf.UP, action: g_(a_, e, !1) },
                      { keyCode: yf.DOWN, action: g_(a_, e, !0) },
                      ...(o
                        ? [
                            {
                              keyCode: yf.UP,
                        ...
                        : []),
                      { keyCode: yf.RIGHT, action: g_(F_, e, !0) },
                      { keyCode: yf.LEFT, action: g_(F_, e, !1) },
                      { keyCode: yf.UP, action: g_(U_, e, !1) },
                      { keyCode: yf.DOWN, action: g_(U_, e, !0) },
                      { keyCode: yf.UP, action: g_(U_, e, !1) },
                      { keyCode: yf.UP, action: g_(u_, e, !1) },
                      { keyCode: yf.DOWN, action: g_(u_, e, !0) },
                      { keyCode: yf.RIGHT, action: g_(b_, e, !0) },
                      { keyCode: yf.LEFT, action: g_(b_, e, !1) },
                      { keyCode: yf.UP, action: g_(v_, e, !1) },
                      { keyCode: yf.DOWN, action: g_(v_, e, !0) },
                      { keyCode: yf.RIGHT, action: g_(hk, e, t, !0) },
                      { keyCode: yf.LEFT, action: g_(hk, e, t, !1) },
                      {
                        keyCode: yf.RIGHT,
                        ctrlKey: !o,
                        altKey: o,
                      ...
                      { keyCode: yf.UP, action: g_(c_, e, !1) },
                      { keyCode: yf.DOWN, action: g_(c_, e, !0) },
                    ],
                    n
                  ).each((e) => {
                    n.preventDefault();
              ...
              (n = o.keyCode === yf.BACKSPACE),
                o.isDefaultPrevented() ||
                  ((e, t, n) => {
                    ...
                    h_(
                      [
                        { keyCode: yf.BACKSPACE, action: g_(Vk, e) },
                        { keyCode: yf.BACKSPACE, action: g_(GE, e, !1) },
                        { keyCode: yf.DELETE, action: g_(GE, e, !0) },
                        { keyCode: yf.BACKSPACE, action: g_(jE, e, !1) },
                        { keyCode: yf.DELETE, action: g_(jE, e, !0) },
                        { keyCode: yf.BACKSPACE, action: g_(kk, e, t, !1) },
                        { keyCode: yf.DELETE, action: g_(kk, e, t, !0) },
                        { keyCode: yf.BACKSPACE, action: g_(gb, e, !1) },
                        { keyCode: yf.DELETE, action: g_(gb, e, !0) },
                        { keyCode: yf.BACKSPACE, action: g_(EN, e, !1, s) },
                        { keyCode: yf.DELETE, action: g_(EN, e, !0, s) },
                        ...(RN
                          ? [
                              {
                                keyCode: yf.BACKSPACE,
                                altKey: !0,
                                action: g_(EN, e, !1, a(!0)),
                              },
                              {
                                keyCode: yf.DELETE,
                                altKey: !0,
                                action: g_(EN, e, !0, a(!0)),
                              },
                              {
                                keyCode: yf.BACKSPACE,
                                metaKey: !0,
                                action: g_(EN, e, !1, a(!1)),
                              },
                            ]
                          : [
                              {
                        ...
                        { keyCode: yf.BACKSPACE, action: g_(tx, e, !1) },
                        { keyCode: yf.DELETE, action: g_(tx, e, !0) },
                        { keyCode: yf.BACKSPACE, action: g_(Mk, e, !1) },
                        { keyCode: yf.DELETE, action: g_(Mk, e, !0) },
                        { keyCode: yf.BACKSPACE, action: g_(DE, e, !1) },
                        { keyCode: yf.DELETE, action: g_(DE, e, !0) },
                        { keyCode: yf.BACKSPACE, action: g_(OE, e, !1) },
                        { keyCode: yf.DELETE, action: g_(OE, e, !0) },
                        { keyCode: yf.BACKSPACE, action: g_(Pk, e, !1) },
                        { keyCode: yf.DELETE, action: g_(Pk, e, !0) },
                        { keyCode: yf.BACKSPACE, action: g_(ex, e, !1) },
                        { keyCode: yf.DELETE, action: g_(ex, e, !0) },
                      ],
                      n
                    )
                      .filter((t) => e.selection.isEditable())
                      .each((t) => {
                        n.preventDefault(),
                          _N(e, o).isDefaultPrevented() || (t(), kN(e, o));
                      });
                  })(e, t, o);
            }),
              e.on("keyup", (t) => {
                t.isDefaultPrevented() ||
                  ((e, t, n) => {
                    p_(
                      [
                        { keyCode: yf.BACKSPACE, action: g_(YE, e) },
                        { keyCode: yf.DELETE, action: g_(YE, e) },
                        ...(RN
                          ? [
                              {
                                keyCode: yf.BACKSPACE,
            ...
            e.on("keydown", (t) => {
              t.isDefaultPrevented() ||
                ((e, t) => {
                  h_(
                    [
                      { keyCode: yf.SPACEBAR, action: g_(NR, e) },
                      { keyCode: yf.SPACEBAR, action: g_(RR, e) },
                    ],
                    t
                  ).each((n) => {
                    t.preventDefault(),
                      _N(e, "insertText", { data: " " }).isDefaultPrevented() ||
                        (n(), kN(e, "insertText", { data: " " }));
                  });
                })(e, t);
            });
          })(e),
            ...
            e.on("keydown", (n) => {
              n.isDefaultPrevented() ||
                ((e, t, n) => {
                  ...
                  p_(
                    [
                      { keyCode: yf.END, action: g_(i_, e, !0) },
                      { keyCode: yf.HOME, action: g_(i_, e, !1) },
                      ...(o
                        ? []
                        : [
                            {
                      ...
                      { keyCode: yf.END, action: g_(y_, e, !0) },
                      { keyCode: yf.HOME, action: g_(y_, e, !1) },
                      { keyCode: yf.END, action: g_(wk, e, !0, t) },
                      { keyCode: yf.HOME, action: g_(wk, e, !1, t) },
                    ],
                    n
                  ).each((e) => {
                    n.preventDefault();
              ...
              e.on("keyup", (o) => {
                o.isDefaultPrevented() ||
                  ((e, t, n) => {
                    p_(
                      [
                        { keyCode: yf.PAGE_UP, action: g_(wk, e, !1, t) },
                        { keyCode: yf.PAGE_DOWN, action: g_(wk, e, !0, t) },
                      ],
                      n
                    );
                  })(e, t, o),
                  wR(o) && n.get() && (ER(n, e, !1), e.nodeChanged());
              });
          })(e, t),
          t
        );
  ...
  const BR = Da("image"),
    ...
    FR =
      ...
      (e) => {
        const t = e;
        return I.from(t[PR]).exists((e) => 0 === e);
      });
  const UR = Da("mode"),
    zR = (e) => (t) => {
      t[UR] = e;
    ...
    qR = (e) => (t) => {
      const n = t;
      return I.from(n[UR]).exists((t) => t === e);
    },
    WR = qR(0),
    KR = qR(1),
    YR = ["none", "copy", "link", "move"],
    GR = [
      "none",
      "copy",
      "copyLink",
    ...
    nA = (e) => -1 !== e.indexOf(eA),
    oA = "%MCEPASTEBIN%",
    rA = (e) => e.dom.get("mcepastebin"),
    sA = (e) => C(e) && "mcepastebin" === e.id,
    aA = (e) => e === oA,
    iA = (e, t) => (
      Dt.each(t, (t) => {
    ...
    dA = (e, t) => ({ content: e, cancelled: t }),
    cA = (e, t) => (e.insertContent(t, { merge: dc(e), paste: !0 }), !0),
    uA = (e) => /^https?:\/\/[\w\-\/+=.,!;:&%@^~(){}?#]+$/i.test(e),
    mA = (e, t, n) =>
      !(e.selection.isCollapsed() || !uA(t)) &&
      ((e, t, n) => (
        e.undoManager.extra(
          () => {
            n(e, t);
    ...
    fA = (e, t, n) =>
      !!((e, t) =>
        uA(t) && $(xc(e), (e) => Ve(t.toLowerCase(), `.${e.toLowerCase()}`)))(
        e,
        t
      ) &&
      ((e, t, n) => (
        ...
        ((e, t, n) => {
          ...
          return e.hasEventListeners("PastePostProcess") &&
            ...
            ? ((e, t, n) => {
                ...
                return dA(r.node.innerHTML, r.isDefaultPrevented());
              })(e, r, n)
            : dA(r, o.isDefaultPrevented());
        })(e, t, n))(e, t, n);
      if (!s.cancelled) {
        const t = s.content,
          n = () =>
            ((e, t, n) => {
              n || !cc(e)
                ? cA(e, t)
                : ((e, t) => {
                    Dt.each([mA, fA, cA], (n) => !n(e, t, cA));
                  })(e, t);
            })(e, t, o);
        r
          ? _N(e, "insertFromPaste", {
              dataTransfer: pA(t),
            }).isDefaultPrevented() || (n(), kN(e, "insertFromPaste"))
          : n();
      }
    },
    bA = (e, t, n, o) => {
      const r = n || nA(t);
      hA(e, ((e) => e.replace(eA, ""))(t), r, !1, o);
    },
    vA = (e, t, n) => {
    ...
    CA = (e, t) => t in e && e[t].length > 0,
    wA = (e) => CA(e, "text/html") || CA(e, "text/plain"),
    EA = (e, t, n) => {
      ...
      if (oc(e) && o) {
        ...
        if (s.length > 0)
          return (
            ...
            ((r = s),
            Promise.all(
              V(r, (e) => ty(e).then((t) => ({ file: e, uri: t })))
            )).then((t) => {
          ...
          (s =
            CA(t, "text/plain") && i
              ...
              : ((e) => {
                  ...
                  return (e = iA(e, [/<!\[[^\]]+\]>/g])), i(n.parse(e)), o;
                })(s)),
        aA(s) || (o ? vA(e, s, r) : bA(e, s, a, r));
    },
    kA = (e, t, n) => {
      ((e, t, n) => {
        let o;
        e.on("keydown", (e) => {
          ...
          e.on("paste", (r) => {
            ...
            o = !1;
            const a = yA(r.clipboardData);
            (!wA(a) && EA(e, r, t.getLastRng() || e.selection.getRng())) ||
              (CA(a, "text/html")
                ? (r.preventDefault(), xA(e, a, a["text/html"], s, !0))
                : CA(a, "text/plain") && CA(a, "text/uri-list")
                ? (r.preventDefault(), xA(e, a, a["text/plain"], s, !0))
                : (t.create(),
                  Tg.setEditorTimeout(
                    e,
                    () => {
                      const n = t.getHtml();
                      t.remove(), xA(e, a, n, s, !1);
                    },
                    0
                  )));
          });
    ...
    NA = (e) => ({
      html: tA(e.selection.getContent({ contextual: !0 })),
    ...
    OA = /rgb\s*\(\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\s*\)/gi,
    BA = (e) => Dt.trim(e).replace(OA, Ws).toLowerCase(),
    PA = (e, t, n) => {
      const o = ic(e);
            ...
            remove: () =>
              ((e, t) => {
                ...
                if (rA(e)) {
                  let o;
                  const r = t.get();
                  for (; (o = rA(e)); ) n.remove(o), n.unbind(o);
        ...
        ((e, t) => {
          e.addCommand("mceTogglePlainTextPaste", () => {
            ...
            e.addCommand("mceInsertClipboardContent", (t, n) => {
              n.html && bA(e, n.html, n.internal, !1),
                n.text && vA(e, n.text, !1);
            });
        })(e, n),
        ((e) => {
          const t = (t) => (n) => {
          ...
          ((e) => {
            e.on(
              ...
              e.on(
                "copy",
                ((e) => (t) => {
                  !t.isDefaultPrevented() && RA(e) && _A(t, NA(e), SA(e), k);
                })(e)
              );
          })(e),
            ((e, t) => {
              nc(e) &&
                ...
                e.on("drop", (n) => {
                  ...
                  (d && !l) ||
                    (i &&
                      ...
                      Tg.setEditorTimeout(e, () => {
                        e.undoManager.transact(() => {
                          (a || (d && l)) && e.execCommand("Delete"), TA(e, o);
                          const t = lA(i);
                          r["text/html"] ? bA(e, t, s, !0) : vA(e, t, !0);
                        });
                      })));
                }),
                e.on("dragstart", (e) => {
                ...
                e.on("dragover dragend", (n) => {
                  oc(e) && !t.get() && (n.preventDefault(), TA(e, AA(e, n))),
    ...
    IA = (e) => vr(e.dom),
    FA = (e) => (t) => _n(Cn(e), t),
    UA = (e, t) => Jn(Cn(e), IA, FA(t)),
    zA = (e, t, n) => {
      const o = new Vo(e, t),
        r = n ? o.next.bind(o) : o.prev.bind(o);
      let s = e;
      for (let t = n ? e : r(); t && !LA(t); t = r()) Bi(t) && (s = t);
      return s;
    },
    jA = (e) => {
      const t = ((e, t, n) => {
        ...
        return (
          UA(s, r).fold(
            () => {
              MA(s) ? i.setStart(s, 0) : i.setStartBefore(s);
            },
            (e) => i.setStartBefore(e.dom)
          ),
          UA(a, r).fold(
            () => {
              MA(a) ? i.setEnd(a, a.data.length) : i.setEndAfter(a);
            },
  ...
  const $A = (e, t) => Math.abs(e.left - t),
    VA = (e, t) => Math.abs(e.right - t),
    qA = (e, t) =>
      ((e) =>
        X(
          e,
    ...
    YA = (e, t, n) =>
      ((e, t, n) => {
        ...
        .map((e) =>
          ((e, t) => ({
            node: e.node,
            position: $A(e, t) < VA(e, t) ? HA.Before : HA.After,
          }))(e, t)
        ),
    GA = (e) => {
      var t, n;
    ...
    ZA = (e, t, n, o) => {
      ...
      return v(o)
        ...
        : ((e, t, n, o) => ({ ...t, dataTransfer: o, type: e, ...XA(n) }))(
            e,
            o,
            t,
            r
    ...
    iT = (e, t, n, o, r) => {
      "dragstart" === t && ZR(o, e.dom.getOuterHTML(n));
      const s = ZA(t, n, o, r);
    ...
    lT = (e, t) => {
      ...
      return (r) =>
        e.on((e) => {
          ...
          if (!e.dragging && s > 10) {
            const n = iT(t, "dragstart", e.element, e.dataTransfer, r);
            if (
            ...
            const s = r.currentTarget === t.getDoc().documentElement,
              l = ((e, t) => ({ pageX: t.pageX - e.relX, pageY: t.pageY + 5 }))(
                ...
                ((e, t) => {
                  return (
                    (n = ((e) =>
                      e.inline ? GA(e.getBody()) : { left: 0, top: 0 })(e)),
                    (o = ((e) => {
                      const t = e.getBody();
                      return e.inline
                    ...
                    (r = ((e, t) => {
                      if (t.target.ownerDocument !== e.getDoc()) {
                        const n = GA(e.getContentAreaContainer()),
                          o = ((e) => {
                            const t = e.getBody(),
    ...
    dT = (e, t, n) => {
      e.on((e) => {
        e.intervalId.clear(),
          e.dragging &&
            n.fold(
              () => iT(t, "dragend", e.element, e.dataTransfer),
              (n) => iT(t, "dragend", e.element, e.dataTransfer, n)
            );
      }),
        cT(e);
    },
    ...
    uT = (e) => {
      const t = Dr(),
        ...
        r = ((e, t) => (n) => {
          if (((e) => 0 === e.button)(n)) {
            const o = Q(t.dom.getParents(n.target), JA).getOr(null);
            if (
              C(o) &&
              ...
              e.set({
                ...
                ghost: eT(t, o, o.offsetWidth, o.offsetHeight),
                intervalId: Pr(100),
              });
            }
          }
        ...
        a = ((e, t) => (n) => {
          e.on((e) => {
            ...
            if ((e.intervalId.clear(), e.dragging)) {
              if (
                ...
                const r =
                  ...
                  void 0 !== o
                    ? o
                    : t.getBody();
                iT(t, "drop", r, e.dataTransfer, n).isDefaultPrevented() ||
                  t.undoManager.transact(() => {
                    ((e, t) => {
              ...
              iT(t, "dragend", t.getBody(), e.dataTransfer, n);
            }
          }),
            cT(e);
        })(t, e),
      ...
      e.on("mousedown", r),
        ...
        e.on("keydown", (n) => {
          n.keyCode === yf.ESC && dT(t, e, I.none());
        });
    },
    mT = vr,
    fT = (e, t) => pb(e.getBody(), t),
    gT = (e) => {
      const t = e.selection,
        n = e.dom,
        o = e.getBody(),
      ...
      return (
        sw(e) ||
          ...
          e.on(
            ...
            (t) => {
              const n = t.target,
                o = fT(e, n);
              mT(o)
                ? (t.preventDefault(), ME(e, o).each(f))
                : l(n) && ME(e, n).each(f);
            },
            !0
          ),
          e.on("mousedown", (r) => {
                ...
                const o = Cn(e.getBody()),
                  ...
                  s = ((e, t, n, o) => {
                    ...
                    return {
                      ...
                      y: o - (e ? r.top + t.dom.clientTop + Iw(t) : 0),
                    };
                  })(e.inline, r, t, n);
                return ((e, t, n) => {
                  const o = Lw(e),
            ...
            const a = fT(e, s);
            mT(a)
              ? (r.preventDefault(), ME(e, a).each(f))
              : YA(o, r.clientX, r.clientY).each((n) => {
                  var o;
                  r.preventDefault(),
                    (o = d(1, n.node, n.position === HA.Before, !1)) &&
                      t.setRng(o),
                    tr(a) ? a.focus() : e.getBody().focus();
                });
          }),
          e.on("keypress", (e) => {
            yf.modifierPressed(e) || (mT(t.getNode()) && e.preventDefault());
          }),
                  ...
                  const t = (t) => {
                      if (!t.isDefaultPrevented()) {
                        ...
                        n &&
                          ...
                          (t.preventDefault(),
                          "drop" === t.type &&
                            Vw(e, "Dropped file type is not supported"));
                      }
                    },
                    n = (n) => {
                      Dg(e, n.target) && t(n);
              ...
              e.on("focusin", (t) => {
                ...
                if (wr(n)) {
                  ...
                  e.selection.getNode() !== o &&
                    ME(e, o).each((t) => e.selection.setRng(t));
                }
              });
            });
          })(e)),
    ...
    yT = (e, t) =>
      vT(e, t.start).bind(({ node: n, offset: o }) =>
        vT(e, t.end).map(({ node: e, offset: t }) => {
          const r = document.createRange();
    ...
    CT = (e, t, n) => {
      if (t && e.isEmpty(t) && !n(t)) {
        const o = t.parentNode;
        e.remove(t, dr(t.firstChild) && Go(t.firstChild.data)), CT(e, o, n);
      }
    },
    wT = (e, t, n, o = !0) => {
    ...
    ET = (e, t) => I.from(e.dom.getParent(t.startContainer, e.dom.isBlock)),
    xT = (e, t, n) => {
    ...
    _T = (e, t) => e.create("span", { "data-mce-type": "bookmark", id: t }),
    ST = (e, t) => {
      const n = e.createRng();
      return n.setStartAfter(t.start), n.setEndBefore(t.end), n;
    },
    NT = (e, t, n) => {
      const o = yT(e.getRoot(), n).getOrDie("Unable to resolve path range"),
        r = o.startContainer,
        s = o.endContainer,
      ...
      return {
        prefix: t,
        end: a.parentNode.insertBefore(_T(e, t + "-end"), a),
        start: l.insertBefore(_T(e, t + "-start"), i),
      };
    },
    RT = (e, t, n) => {
      CT(e, e.get(t.prefix + "-end"), n), CT(e, e.get(t.prefix + "-start"), n);
    },
    AT = (e) => 0 === e.start.length,
    TT = (e, t, n, o) => {
      const r = t.start;
      var s;
      return X_(
        ...
        }
        {
          ...
          return Y_(o.container, s, n)
            ...
            .orThunk(() => TT(e, t, n, V_(o.container, 0)));
        }
      });
    },
    OT = (e, t, n, o) => {
      const r = e.dom,
        ...
        l = n.position.offset;
      return Y_(i, l - n.pattern.end.length, t).bind((d) => {
        const c = bT(r, s, d.container, d.offset, i, l, o);
        if (AT(a))
          return I.some({
        ...
        {
          const i = BT(e, n.remainingPatterns, d.container, d.offset, t, o),
          ...
          return m.map((e) => {
            ...
            return {
              ...
              position: V_(e.startContainer, e.startOffset),
            };
          });
        }
      });
    ...
    BT = (e, t, n, o, r, s) => {
      const a = e.dom;
      return K_(n, o, a.getRoot()).bind((i) => {
        const l = kT(a, r, n, o);
        for (let a = 0; a < t.length; a++) {
          const d = t[a];
          ...
          if (u.isNone() && o > 0) return BT(e, t, n, o - 1, r, s);
    ...
    DT = (e, t, n, o, r, s) => {
      ...
      return ((e, t) => {
        ...
        BT(e, r.inlinePatterns, n, o, t, s).fold(
          () => [],
          (e) => e.matches
        ),
        BT(
    ...
    LT = (e, t) => {
        ...
        r = ((e, t) => {
          const n = Da("mce_textpattern"),
            o = G(
              t,
              (t, o) => {
                const r = NT(e, n + `_end${t.length}`, o.endRng);
      ...
      q(r, (t) => {
        ...
        AT(t.pattern)
          ...
          RT(n, t.endMarker, r),
          RT(n, t.startMarker, r);
      }),
        e.selection.moveToBookmark(o);
    },
    MT = (e, t, n) =>
      ((e, t, n) => {
        if (dr(e) && 0 >= e.length) return I.some(V_(e, 0));
        {
          const t = Ua(q_);
          return I.from(t.forwards(e, 0, W_(e), n)).map((e) =>
            V_(e.container, 0)
          );
        }
      })(t, 0, t).map((o) => {
    ...
    IT = (e) => (t, n) => {
      const o = t.dom,
        r = n.pattern,
        s = yT(o.getRoot(), n.range).getOrDie("Unable to resolve path range");
      return (
        ET(t, s).each((n) => {
          "block-format" === r.type
            ? ((e, t) => {
        ...
        ? e(r.blockPatterns, a)
            .map((e) =>
              t && Dt.trim(a).length === e.start.length
                ? []
                : [{ pattern: e, range: bT(l, l.getRoot(), o, 0, o, 0, s) }]
            )
            .getOr([])
        : [];
    },
    ...
    jT = FT((e, t, n) => 0 === t.indexOf(e.start) || 0 === n.indexOf(e.start)),
    HT = UT(jT, !0),
    $T = IT(MT),
    VT = FT((e, t, n) => t === e.start || n === e.start),
    qT = UT(VT, !1),
    WT = (e, t, n) => {
    ...
    KT = (e) => {
                ...
                ((e, t) => {
                  ...
                  return ET(e, n)
                    .map((o) => {
                      ...
                      return {
                        inlineMatches: DT(e, o, n.startContainer, s, a, !0),
                        blockMatches: HT(e, o, a, !0),
                      };
                    })
                    .filter(
            ...
            ((e, t) => {
              ...
              ET(e, n).map((o) => {
                const r = Math.max(0, n.startOffset - 1),
                  s = kT(e.dom, o, n.startContainer, r),
                  a = xT(t, o, s),
                  i = DT(e, o, n.startContainer, r, a, !1);
                i.length > 0 &&
                  e.undoManager.transact(() => {
                    LT(e, i);
                  });
      ...
      e.on("keyup", (e) => {
        WT(n, e, (e, t) => e === t.keyCode && !yf.modifierPressed(t)) && s();
      }),
        e.on("keypress", (n) => {
          WT(t, n, (e, t) => e.charCodeAt(0) === t.charCode) &&
    ...
    GT = ma.DOM,
    XT = (e) => (e.inline ? e.getElement().nodeName.toLowerCase() : void 0),
    ZT = (e) => Ce(e, (e) => !1 === v(e)),
    QT = (e) => {
    ...
    eO = (e) => (e.inline ? e.ui.styleSheetLoader : e.dom.styleSheetLoader),
    tO = (e) => {
      const t = eO(e),
        n = pd(e),
        o = e.contentCSS,
      ...
      const a = Promise.all(
          ((e, t, n) => {
            const { pass: o, fail: r } = K(t, (e) =>
                tinymce.Resource.has(Yw(e))
              ),
              s = o.map((t) => {
                const n = tinymce.Resource.get(Yw(t));
                return m(n)
                  ? Promise.resolve(eO(e).loadRawCss(t, n))
                  : Promise.resolve();
              }),
              a = [...s, eO(e).loadAll(r)];
    ...
    nO = (e) => {
      !0 !== e.removed &&
        (((e) => {
          sw(e) || e.load({ initial: !0, format: "html" }),
    ...
    oO = (e) => {
      ...
      let n = e.getDoc();
      e.inline &&
        (GT.addClass(t, "mce-content-body"),
      ...
      (o.disabled = !0),
        ...
        !e.readonly &&
          e.hasEditableRoot() &&
          (e.inline &&
            "static" === GT.getStyle(o, "position", !0) &&
        ...
        (e.selection = fw(e.dom, e.getWin(), e.serializer, e)),
        (e.annotator = df(e)),
        (e.formatter = fE(e)),
        (e.undoManager = pE(e)),
        (e._nodeChangeDispatcher = new OR(e)),
        (e._selectionOverrides = gT(e)),
        ((e) => {
          const t = Dr(),
            n = Br(!1),
            o = wa((t) => {
            ...
            e.on("BeforeSetContent", (t) => {
              ((e, t, n) => {
                let o = t.length,
                  r = n.content;
                if ("raw" !== n.format) {
                  for (; o--; ) r = r.replace(t[o], Jk(e, r, hc(e)));
                  n.content = r;
                }
              })(e, a, t);
            }),
        ...
        sw(e) ||
          (((e) => {
            e.on("mousedown", (t) => {
              t.detail >= 3 && (t.preventDefault(), jA(e));
            });
          })(e),
          ((e) => {
            KT(e);
          ...
          e.on("NodeChange", () =>
            ((e) => {
              ...
              if (
                ...
                ((e, t, n) => $(Up(Cn(n), Cn(t)), (t) => Kk(e, t.dom)))(r, a, s)
              )
                return;
              if (a.firstChild === a.lastChild && pr(a.firstChild))
                return (
                  (i = Xk(e)),
              ...
              for (; m; )
                if ((er(m) && Kr(o, m), Yk(o, m))) {
                  ...
                  if (!i) {
                    ...
                    (i = Xk(e)), a.insertBefore(i, m);
                  }
                  (l = m), (m = m.nextSibling), i.appendChild(l);
                } else (i = null), (m = m.nextSibling);
              d && (e.selection.setRng(JE(d)), e.nodeChanged());
            })(e)
          );
        })(e),
        ((e) => {
            ...
            s = (t, a) => {
              ...
              const i = e.getBody(),
                l =
                  !((e) =>
                    vE(e) &&
                    !(yE(e) || ("keyup" === e.type && 229 === e.keyCode)))(t) &&
                  ((e, t, n) => {
                    if (
              ...
              (("" !== n.getAttrib(i, bE)) !== l || a) &&
                (n.setAttrib(i, bE, l ? r : null),
                ((e, t) => {
      ...
      ((e) => {
        ...
        ((e) => {
          ...
          ec(e) ||
            ((t.body.spellcheck = !1), GT.setAttrib(n, "spellcheck", "false")),
          (e.quirks = YT(e)),
          ((e) => {
          ...
          (t) => {
            e.setProgressState(!0),
              tO(e).then(() => {
                t().then(
                  (t) => {
                    e.setProgressState(!1), nO(e), lw(e);
                  },
                  (t) => {
                    e.notificationManager.open({
                      type: "error",
    ...
    sO = ma.DOM,
    aO = ma.DOM,
    iO = (e, t) => ({ editorContainer: e, iframeContainer: t, api: {} }),
    lO = (e) => {
      const t = e.getElement();
      return e.inline
        ? iO(null)
        : ((e) => {
            ...
            return aO.insertAfter(t, e), iO(t, t);
          })(t);
    },
    dO = async (e) => {
      e.dispatch("ScriptsLoaded"),
        ((e) => {
          const t = Dt.trim(td(e)),
            ...
            o = { ...Ow.get("default").icons, ...Ow.get(t).icons };
          pe(o, (t, o) => {
        ...
        ((e) => {
          ...
          if (m(t)) {
            const n = jw.get(t);
            (e.theme = n(e, jw.urls[t]) || {}),
              w(e.theme.init) &&
                e.theme.init(
                  e,
                  jw.urls[t] || e.documentBaseUrl.replace(/\/$/, "")
                );
          } else e.theme = {};
        })(e),
        ((e) => {
        ...
        ((e) => {
          ...
          q($d(e), (n) => {
            ((e, t, n) => {
              const o = zw.get(n),
                r = zw.urls[n] || e.documentBaseUrl.replace(/\/$/, "");
    ...
    fO = (e, t) => {
      ...
      ((e, t) => {
        ...
        if (m(n) && !uO(n) && !ke(jw.urls, n)) {
          ...
          jw.load(n, r).catch(() => {
            ((e, t, n) => {
              qw(e, "ThemeLoadError", Ww("theme", t, n));
            })(e, r, n);
          });
        }
      })(e, t),
        ((e, t) => {
          ...
          if ("plugin" !== n && !ke(Bw.urls, n)) {
            ...
            Bw.load(n, r).catch(() => {
              ((e, t, n) => {
                qw(e, "ModelLoadError", Ww("model", t, n));
              })(e, r, n);
            });
          }
        })(e, t),
        ((e, t) => {
          ...
          if (!va.hasCode(n) && "en" !== n) {
            ...
            e.add(r).catch(() => {
              ((e, t, n) => {
                qw(e, "LanguageLoadError", Ww("language", t, n));
              })(t, r, n);
            });
          }
        })(n, e),
        ((e, t, n) => {
          const o = mO(t, "default", n),
            r = ((e) =>
              I.from(nd(e))
                .filter(Ge)
          ...
          q(
            ...
            (n) => {
              e.add(n.url).catch(() => {
                ((e, t, n) => {
                  qw(e, "IconsLoadError", Ww("icons", t, n));
        ...
        ((e, t) => {
          const n = (t, n) => {
            zw.load(t, n).catch(() => {
              ((e, t, n) => {
                qw(e, "PluginLoadError", Ww("plugin", t, n));
              })(e, n, t);
            });
          };
          pe(Vd(e), (t, o) => {
    ...
    EO = (e, t, n, o, r) => {
      var s;
      const a = e
          ? { mobile: CO(null !== (s = r.mobile) && void 0 !== s ? s : {}, t) }
          : {},
        i = vO(["mobile"], mS(a, r)),
        l = Dt.extend(
          n,
          ...
          ((e, t) => e && yO(t, "mobile"))(e, i)
            ...
            : {},
          { external_plugins: wO(o, i.options()) }
        );
      return ((e, t, n, o) => {
        const r = bO(n.forced_plugins),
          s = bO(o.plugins),
          a = ((e, t) => (yO(e, t) ? e.sections()[t] : {}))(t, "mobile"),
          i = ((e, t, n, o) => (e && yO(t, "mobile") ? o : n))(
            e,
            t,
            s,
    ...
    _O = (e, t) => {
      if (e.selection.isEditable()) {
        ...
        TC(e, {
          ...
          const n = ((e, t, n) => aw(e).editor.insertContent(t, n))(
            e,
            t.content,
            o
          );
          OC(e, n, t), e.addVisual();
        });
      }
    },
    SO = { "font-size": "size", "font-family": "face" },
    NO = Zt("font"),
    RO = (e) => (t, n) =>
      I.from(n)
        .map(Cn)
          ...
          ((e, t, n) =>
            Hb(
              ...
              (t) =>
                ((t) =>
                  fo(t, e).orThunk(() =>
                    NO(t) ? xe(SO, e).bind((e) => nn(t, e)) : I.none()
                  ))(t),
              (e) => _n(Cn(t), e)
            ))(e, t, n.dom).or(
            ((e, t) => I.from(ma.DOM.getStyle(t, e, !0)))(e, n.dom)
          )
        )
        .getOr(""),
    AO = RO("font-size"),
      ...
      xO(e),
        ...
        ((e) => {
          e.editorCommands.addCommands({
            ...
            insertImage: (t, n, o) => {
              _O(e, e.dom.createHTML("img", { src: o }));
            },
        ...
        ((e) => {
          e.editorCommands.addCommands({
            ...
            e.editorCommands.addCommands({ Outdent: () => Uk(e) }, "state");
        })(e),
        ((e) => {
          e.editorCommands.addCommands({
          ...
          ((e) => {
            ...
            e.editorCommands.addCommands({
              ...
              FontName: (t, n, o) => {
                ((e, t) => {
                  const n = PO(e, t);
                  e.formatter.toggle("fontname", { value: DO(n) }),
                    e.nodeChanged();
                })(e, o);
              },
              FontSize: (t, n, o) => {
                ((e, t) => {
                  e.formatter.toggle("fontsize", { value: PO(e, t) }),
                    e.nodeChanged();
                })(e, o);
              },
              LineHeight: (t, n, o) => {
            ...
            ((e) => {
              ...
              e.editorCommands.addCommands(
                ...
                e.editorCommands.addQueryValueHandler("FontName", () =>
                  ((e) => BO(e, (t) => TO(e.getBody(), t.dom)).getOr(""))(e)
                ),
                e.editorCommands.addQueryValueHandler("FontSize", () =>
                  ((e) => BO(e, (t) => AO(e.getBody(), t.dom)).getOr(""))(e)
                ),
                e.editorCommands.addQueryValueHandler("LineHeight", () =>
                  ((e) =>
                    BO(e, (t) => {
                      const n = Cn(e.getBody()),
                        o = Hb(t, (e) => fo(e, "line-height"), T(_n, n));
                      return o.getOrThunk(() => {
  ...
  class UO {
    ...
    queryCommandState(e) {
      if ((!FO(e) && this.editor.quirks.isHidden()) || this.editor.removed)
        return !1;
      const t = e.toLowerCase(),
  ...
  const YO = (e) => (
      e._eventDispatcher ||
        (e._eventDispatcher = new KO({
          scope: e,
          toggleEvent: (t, n) => {
            KO.isNative(t) && e.toggleNativeEvent && e.toggleNativeEvent(t, n);
          },
        })),
      e._eventDispatcher
    ),
    GO = {
      ...
      on(e, t, n) {
        return YO(this).on(e, t, n);
      },
      off(e, t) {
        return YO(this).off(e, t);
      },
      once(e, t) {
        return YO(this).once(e, t);
      },
      hasEventListeners(e) {
        return YO(this).has(e);
      },
    },
    XO = ma.DOM;
  let ZO;
  const QO = (e, t) => {
      ...
      const n = wd(e);
      return n
        ? (e.eventRoot || (e.eventRoot = XO.select(n)[0]), e.eventRoot)
        : e.getBody();
    },
    JO = (e, t, n) => {
      ((e) => !e.hidden && !$O(e))(e)
        ...
        : $O(e) &&
          ((e, t) => {
            ...
            } else ((e) => H(qO, e.type))(t) && e.dispatch(t.type, t);
          })(e, n);
    },
    eB = (e, t) => {
      ...
      if (wd(e)) {
        ...
        const o = (n) => {
          ...
          for (; s--; ) {
            const e = r[s].getBody();
            (e === o || XO.isChildOf(o, e)) && JO(r[s], t, n);
          }
        };
        (ZO[t] = o), XO.bind(n, t, o);
      } else {
        const o = (n) => {
          JO(e, t, n);
        };
        XO.bind(n, t, o), (e.delegates[t] = o);
      }
    },
    tB = {
      ...GO,
        ...
        "focus" !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                n.delegates &&
                (n.dom.unbind(QO(n, e), e, n.delegates[e]),
    ...
    oB = (e, t) => e + (Xe(t.message) ? "" : `. ${t.message}`),
    rB = (e) => e.valid,
    sB = (e, t, n = "") => {
      const o = t(e);
      return b(o)
    ...
    uB = Dt.makeMap("alt,ctrl,shift,meta,access"),
    mB = (e) => {
      const t = {},
        n = Tt.os.isMacOS() || Tt.os.isiOS();
      lB(dB(e.toLowerCase(), "+"), (e) => {
        ((e) => e in uB)(e)
          ? (t[e] = !0)
          : /^[0-9]{2,}$/.test(e)
          ? (t.keyCode = parseInt(e, 10))
          : ((t.charCode = e.charCodeAt(0)),
            (t.keyCode = cB[e] || e.toUpperCase().charCodeAt(0)));
      });
      const o = [t.keyCode];
      let r;
      for (r in uB) t[r] ? o.push(r) : (t[r] = !1);
      return (
        (t.id = o.join(",")),
  ...
  class vB {
    constructor(e, t, n) {
        ...
        const o = {},
          ...
          s = (e, t, n) => {
            ...
            return rB(o)
              ? ((r[e] = o.value), !0)
              : (console.warn(
                  oB(`Invalid value passed for the ${e} option`, o)
                ),
                !1);
          },
          a = (e) => ke(o, e);
          ...
          register: (e, n) => {
            const a = ((e) => m(e.processor))(n)
                ? ((e) => {
                    ...
                    return (n) => sB(n, t, `The value must be a ${e}.`);
                  })(n.processor)
                : n.processor,
              i = ((e, t, n) => {
                if (!v(t)) {
                  const o = sB(t, n);
                  if (rB(o)) return o.value;
                  console.error(
                    oB(`Invalid default value passed for the "${e}" option`, o)
                  );
                }
              })(e, n.default, a);
      ...
      const l = ld(o);
      l &&
        (ga.ScriptLoader._setReferrerPolicy(l),
      ...
      C(d) && ma.DOM.styleSheetLoader._setContentCssCors(d),
        ...
        this.setDirty(!1),
        (this.documentBaseURI = new uC(zl(o), { base_uri: this.baseUri })),
        (this.baseURI = this.baseUri),
        (this.inline = Pd(o)),
        (this.hasVisual = Wd(o)),
        (this.shortcuts = new fB(this)),
        (this.editorCommands = new UO(this)),
        MO(this);
    ...
    render() {
      ((e) => {
        ...
        va.setCode(dd(e));
        const n = () => {
          cO.unbind(window, "ready", n), e.render();
        };
        if (!na.Event.domLoaded) return void cO.bind(window, "ready", n);
        ...
        e.on("remove", () => {
          ...
          (e.ui.styleSheetLoader = ((e, t) =>
            rs.forElement(e, { contentCssCors: Hd(t), referrerPolicy: ld(t) }))(
            o,
            e
          )),
          Pd(e)
        ...
        const s = e.getElement().form || cO.getParent(t, "form");
        s &&
          ((e.formElement = s),
          Dd(e) &&
            !lr(e.getElement()) &&
            (cO.insertAfter(cO.create("input", { type: "hidden", name: t }), t),
            (e.hasHiddenInput = !0)),
          (e.formEventDelegate = (t) => {
            e.dispatch(t.type, t);
          }),
          cO.bind(s, "submit reset", e.formEventDelegate),
          e.on("reset", () => {
            e.resetContent();
          }),
          !Ld(e) ||
          ...
          (e.windowManager = Hw(e)),
          (e.notificationManager = Uw(e)),
          ((e) => "xml" === e.options.get("encoding"))(e) &&
            e.on("GetContent", (e) => {
              e.save && (e.content = cO.encode(e.content));
            }),
          Md(e) &&
            e.on("submit", () => {
    ...
    hasPlugin(e, t) {
      return !(!H($d(this), e) || (t && void 0 === zw.get(e)));
    }
    nodeChanged(e) {
    ...
    show() {
      ...
      e.hidden &&
        ...
        e.inline
          ...
          : (pB.show(e.getContainer()), pB.hide(e.id)),
        e.load(),
        e.dispatch("show"));
    }
    hide() {
      ...
      e.hidden ||
        ...
        e.inline
          ...
          : (pB.hide(e.getContainer()),
            pB.setStyle(e.id, "display", e.orgDisplay)),
        (e.hidden = !0),
        e.dispatch("hide"));
    }
    isHidden() {
    ...
    save(e = {}) {
      ...
      if (
        ...
        const o = pB.getParent(t.id, "form");
        o && bB(o.elements, (e) => e.name !== t.id || ((e.value = r), !1));
      }
      return (
    ...
    getContent(e) {
      return ((e, t = {}) => {
        ...
        return RC(e, n).fold(R, (t) => {
          const n = ((e, t) => aw(e).editor.getContent(t))(e, t);
          return AC(e, n, t);
        });
      })(this, e);
    }
    ...
    resetContent(e) {
      void 0 === e
        ? bw(this, this.startContent, { format: "raw" })
        : bw(this, e),
    ...
    getContainer() {
      ...
      return (
        e.container ||
          (e.container = e.editorContainer || pB.get(e.id + "_parent")),
        e.container
      );
    }
    ...
    getElement() {
      return (
        this.targetElm || (this.targetElm = pB.get(this.id)), this.targetElm
      );
    }
    getWin() {
      const e = this;
  ...
  const kB = (e) => {
    ...
    _B = (e) => {
      if (e !== EB) {
        const t = ma.DOM;
        e
          ? (t.bind(window, "resize", kB), t.bind(window, "scroll", kB))
          : (t.unbind(window, "resize", kB), t.unbind(window, "scroll", kB)),
          (EB = e);
      }
    },
    SB = (e) => {
      ...
      return (
        (xB = Y(xB, (t) => e !== t)),
        RB.activeEditor === e &&
          (RB.activeEditor = xB.length > 0 ? xB[0] : null),
        RB.focusedEditor === e && (RB.focusedEditor = null),
        t.length !== xB.length
      );
    },
    NB = "CSS1Compat" !== document.compatMode,
    RB = {
      ...GO,
      baseURI: null,
      baseURL: null,
      ...
      setup() {
        ...
        let t = "",
          n = "",
          o = uC.getDocumentBaseUrl(document.location);
        /^[^:]+:\/\/\/?[^\/]+\//.test(o) &&
          ((o = o.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, "")),
          /[\/\\]$/.test(o) || (o += "/"));
        ...
        var s;
        (e.baseURL = new uC(o).toAbsolute(t)),
          (e.documentBaseURL = o),
          (e.baseURI = new uC(e.baseURL)),
          (e.suffix = n),
        ...
        return (
          n === e ||
            ...
            wB ||
              ...
              window.addEventListener("beforeunload", wB))),
          e
        );
      },
      createEditor(e, t) {
        return this.add(new vB(e, t, this));
      },
      remove(e) {
        const t = this;
        let n;
        if (e) {
          if (!m(e))
            return (
              ...
              h(t.get(n.id))
                ? null
                : (SB(n) && t.dispatch("RemoveEditor", { editor: n }),
                  0 === xB.length &&
                    window.removeEventListener("beforeunload", wB),
                  n.remove(),
                  _B(xB.length > 0),
                  n)
            );
        ...
        } else for (let e = xB.length - 1; e >= 0; e--) t.remove(xB[e]);
      },
      execCommand(e, t, n) {
        var o;
        const r = this,
      ...
      _setBaseUrl(e) {
        (this.baseURL = new uC(this.documentBaseURL).toAbsolute(
          e.replace(/\/+$/, "")
        )),
          (this.baseURI = new uC(this.baseURL));
      },
    };
  RB.setup();
  const AB = (() => {
    ...
    DB = (e, t, n, o) => ({ x: e, y: t, w: n, h: o }),
    LB = {
      inflate: (e, t, n) => DB(e.x - t, e.y - n, e.w + 2 * t, e.h + 2 * n),
      relativePosition: PB,
      ...
      intersect: (e, t) => {
        const n = OB(e.x, t.x),
          o = OB(e.y, t.y),
          r = TB(e.x + e.w, t.x + t.w),
          s = TB(e.y + e.h, t.y + t.h);
        return r - n < 0 || s - o < 0 ? null : DB(n, o, r - n, s - o);
      },
      clamp: (e, t, n) => {
        let o = e.x,
          r = e.y,
      ...
      create: DB,
      fromClientRect: (e) => DB(e.left, e.top, e.width, e.height),
    },
    MB = (() => {
      const e = {},
        t = {},
        ...
        load: (n, o) => {
          ...
          if (void 0 !== e[n]) return e[n];
          {
            const a = new Promise((e, a) => {
              ...
              (t[n] = i.resolve),
                ga.ScriptLoader.loadScript(o).then(
                  () => i.start(s),
                  () => i.reject(r)
                );
            });
  ...
  try {
    ...
    (IB = window.localStorage), IB.setItem(e, e), IB.removeItem(e);
  } catch (e) {
    IB = (() => {
      let e = {},
        t = [];
  ...
  const FB = {
      ...
      util: {
        ...
        ImageUploader: (e) => {
          const t = Zw(),
            n = tE(e, t);
          return { upload: (t, o = !0) => n.upload(t, o ? eE(e) : void 0) };
        },
      },
      dom: {
        EventUtils: na,
