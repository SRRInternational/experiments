      ...
      <main>
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
          ...
          <div class="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
            <!-- ====== Chart One Start -->
            <include src="./partials/chart-01.php" />
            <!-- ====== Chart One End -->

            <!-- ====== Chart Two Start -->
            <include src="./partials/chart-02.php" />
            <!-- ====== Chart Two End -->

            <!-- ====== Chart Three Start -->
            <include src="./partials/chart-03.php" />
            <!-- ====== Chart Three End -->

            <!-- ====== Map One Start -->
            <include src="./partials/map-01.php" />
            <!-- ====== Map One End -->

            <!-- ====== Table One Start -->
            <div class="col-span-12 xl:col-span-8">
              <include src="./partials/table-01.php" />
            </div>
            <!-- ====== Table One End -->
            ...
            <div class="col-span-12 rounded-sm border border-stroke bg-white py-6 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4">
              ...
              <div>
                <a href="messages.php" class="flex items-center gap-5 px-7.5 py-3 hover:bg-gray-3 dark:hover:bg-meta-4">
