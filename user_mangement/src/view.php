                    ...
                    <div class="mx-auto max-w-242.5">
                        ...
                        <div class="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                            <div class="relative z-20 h-35 md:h-65">
                                <img src=<?php echo $userInfo['image'] ? $userInfo['image'] : './images/cover/cover-01.png' ?> alt="profile cover" class="h-full w-full rounded-tl-sm rounded-tr-sm object-cover object-center" />
                            ...
                            <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
                                <div class="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
                                    <div class="relative drop-shadow-2 w-full h-full">
                                        <img src="<?php echo $userInfo['image']; ?>" class="rounded-full w-full h-full object-cover" alt="profile" />
                                ...
                                <div class="mt-4">
                                    <h3 class="mb-1.5 text-2xl font-medium text-neutral-500 dark:text-white items-center justify-center flex">
                                        <span class=" text-lg">@</span><?php echo $userInfo['username']; ?>
                                    </h3>
                                    <p class="font-medium"><?php echo $userInfo['firstname']; ?> <?php echo $userInfo['lastname']; ?></p>
                                    <div class="flex items-center justify-center py-2">

                                        <p class="font-medium flex items-center gap-2"><span><svg width="20px" height="20px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                                ...
                                                </svg></span> <?php echo $userInfo['country']; ?></p>
                                    </div>
