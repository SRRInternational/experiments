    ...
    <div class="bg-white flex gap-4 p-8 justify-between w-[1100px] rounded-3xl shadow-md">
        ...
        <form class="w-full" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="file" name="image" class="w-full cursor-pointer rounded-lg border-[1.5px] border-stroke bg-transparent font-normal outline-none transition file:mr-5 file:border-none file:cursor-pointer file:border-0 file:border-r  file:border-stroke file:bg-whiter file:px-5 file:py-3 file:hover:bg-blue-600 file:hover:bg-opacity-10 focus:border-blue-600 active:border-primary disabled:cursor-default disabled:bg-whiter " />
            </div>
            <div class=" w-full mb-4 flex items-end justify-end ">
                <button type="submit" class="self-end  bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600">Create account</button>
            </div>
        </form>
    </div>
